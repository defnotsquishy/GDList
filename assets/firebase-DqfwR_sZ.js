 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ln(r){try{return(r.startsWith("http://")||r.startsWith("https://")?new URL(r).hostname:r).endsWith(".cloudworkstations.dev")}catch{return!1}}async function gc(r){return(await fetch(r,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class V_{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(D_(t)){const n=t.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(t=>t).join(" ")}}function D_(r){const e=r.getComponent();return(e==null?void 0:e.type)==="VERSION"}const La="@firebase/app",Ml="0.13.2";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Et=new _c("@firebase/app"),k_="@firebase/app-compat",N_="@firebase/analytics-compat",x_="@firebase/analytics",O_="@firebase/app-check-compat",M_="@firebase/app-check",L_="@firebase/auth",F_="@firebase/auth-compat",U_="@firebase/database",B_="@firebase/data-connect",j_="@firebase/database-compat",q_="@firebase/functions",$_="@firebase/functions-compat",z_="@firebase/installations",K_="@firebase/installations-compat",G_="@firebase/messaging",W_="@firebase/messaging-compat",H_="@firebase/performance",Q_="@firebase/performance-compat",X_="@firebase/remote-config",J_="@firebase/remote-config-compat",Y_="@firebase/storage",Z_="@firebase/storage-compat",ey="@firebase/firestore",ty="@firebase/ai",ny="@firebase/firestore-compat",ry="firebase",iy="11.10.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fy=1024,py=30;class my{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new _y(t),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=Ul();if(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(o=>o.date===s))return;if(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats.length>py){const o=yy(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(o,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(n){Et.warn(n)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Ul(),{heartbeatsToSend:n,unsentEntries:i}=gy(this._heartbeatsCache.heartbeats),s=$s(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return Et.warn(t),""}}}function Ul(){return new Date().toISOString().substring(0,10)}function gy(r,e=fy){const t=[];let n=r.slice();for(const i of r){const s=t.find(o=>o.agent===i.agent);if(s){if(s.dates.push(i.date),Bl(t)>e){s.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),Bl(t)>e){t.pop();break}n=n.slice(1)}return{heartbeatsToSend:t,unsentEntries:n}}class _y{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Gd()?r_().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await dy(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return Fl(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return Fl(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function Bl(r){return $s(JSON.stringify({version:2,heartbeats:r})).length}function yy(r){if(r.length===0)return-1;let e=0,t=r[0].date;for(let n=1;n<r.length;n++)r[n].date<t&&(t=r[n].date,e=n);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ks=new _c("@firebase/auth");function Ty(r,...e){Ks.logLevel<=H.WARN&&Ks.warn(`Auth (${Fn}): ${r}`,...e)}function Ps(r,...e){Ks.logLevel<=H.ERROR&&Ks.error(`Auth (${Fn}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function We(r,...e){throw Tc(r,...e)}function Ge(r,...e){return Tc(r,...e)}function Ec(r,e,t){const n=Object.assign(Object.assign({},Ey()),{[e]:t});return new xi("auth","Firebase",n).create(e,{appName:r.name})}function _t(r){return Ec(r,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function ef(r,e,t){const n=t;if(!(e instanceof n))throw n.name!==e.constructor.name&&We(r,"argument-error"),Ec(r,"argument-error",`Type of ${e.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)}function Tc(r,...e){if(typeof r!="string"){const t=e[0],n=[...e.slice(1)];return n[0]&&(n[0].appName=r.name),r._errorFactory.create(t,...n)}return Zd.create(r,...e)}function q(r,e,...t){if(!r)throw Tc(e,...t)}function pt(r){const e="INTERNAL ASSERTION FAILED: "+r;throw Ps(e),new Error(e)}function Tt(r,e){r||pt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ba(){var r;return typeof self<"u"&&((r=self.location)===null||r===void 0?void 0:r.href)||""}function vy(){return jl()==="http:"||jl()==="https:"}function jl(){var r;return typeof self<"u"&&((r=self.location)===null||r===void 0?void 0:r.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vc(r,e){Tt(r.emulator,"Emulator should always be set here");const{url:t}=r.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function BA(r,e=!1){return ee(r).getIdToken(e)}async function Ny(r,e=!1){const t=ee(r),n=await t.getIdToken(e),i=wc(n);q(i&&i.exp&&i.auth_time&&i.iat,t.auth,"internal-error");const s=typeof i.firebase=="object"?i.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:i,token:n,authTime:ci(Aa(i.auth_time)),issuedAtTime:ci(Aa(i.iat)),expirationTime:ci(Aa(i.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function Aa(r){return Number(r)*1e3}function wc(r){const[e,t,n]=r.split(".");if(e===void 0||t===void 0||n===void 0)return Ps("JWT malformed, contained fewer than 3 sections"),null;try{const i=Ld(t);return i?JSON.parse(i):(Ps("Failed to decode base64 JWT payload"),null)}catch(i){return Ps("Caught error parsing JWT payload as JSON",i==null?void 0:i.toString()),null}}function $l(r){const e=wc(r);return q(e,"internal-error"),q(typeof e.exp<"u","internal-error"),q(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tr{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){q(e.idToken,"internal-error"),q(typeof e.idToken<"u","internal-error"),q(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):$l(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){q(e.length!==0,"internal-error");const t=$l(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(q(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:s}=await Fy(e,t);this.updateTokensAndExpiration(n,i,Number(s))}updateTokensAndExpiration(e,t,n){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+n*1e3}static fromJSON(e,t){const{refreshToken:n,accessToken:i,expirationTime:s}=t,o=new tr;return n&&(q(typeof n=="string","internal-error",{appName:e}),o.refreshToken=n),i&&(q(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),s&&(q(typeof s=="number","internal-error",{appName:e}),o.expirationTime=s),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new tr,this.toJSON())}_performRefresh(){return pt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zl=new Map;function mt(r){Tt(r instanceof Function,"Expected a class definition");let e=zl.get(r);return e?(Tt(e instanceof r,"Instance stored in cache mismatched with class"),e):(e=new r,zl.set(r,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class of{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}of.type="NONE";const Kl=of;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ss(r,e,t){return`firebase:${r}:${e}:${t}`}class nr{constructor(e,t,n){this.persistence=e,this.auth=t,this.userKey=n;const{config:i,name:s}=this.auth;this.fullUserKey=Ss(this.userKey,i.apiKey,s),this.fullPersistenceKey=Ss("persistence",i.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await Gs(this.auth,{idToken:e}).catch(()=>{});return t?Xe._fromGetAccountInfoResponse(this.auth,t,e):null}return Xe._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,n="authUser"){if(!t.length)return new nr(mt(Kl),e,n);const i=(await Promise.all(t.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let s=i[0]||mt(Kl);const o=Ss(n,e.config.apiKey,e.name);let c=null;for(const h of t)try{const f=await h._get(o);if(f){let m;if(typeof f=="string"){const g=await Gs(e,{idToken:f}).catch(()=>{});if(!g)break;m=await Xe._fromGetAccountInfoResponse(e,g,f)}else m=Xe._fromJSON(e,f);h!==s&&(c=m),s=h;break}}catch{}const u=i.filter(h=>h._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new nr(s,e,n):(s=u[0],c&&await s._set(o,c.toJSON()),await Promise.all(t.map(async h=>{if(h!==s)try{await h._remove(o)}catch{}})),new nr(s,e,n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mf(r,e=[]){let t;switch(r){case"Browser":t=Gl(ye());break;case"Worker":t=`${Gl(ye())}-${r}`;break;default:t=r}const n=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Fn}/${n}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rr(r,e){return Li(r,"POST","/v1/accounts:signInWithIdp",At(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pI(r){switch(r){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function mI(r){const e=ti(ni(r)).link,t=e?ti(ni(e)).deep_link_id:null,n=ti(ni(r)).deep_link_id;return(n?ti(ni(n)).link:null)||n||t||e||r}class bc{constructor(e){var t,n,i,s,o,c;const u=ti(ni(e)),h=(t=u.apiKey)!==null&&t!==void 0?t:null,f=(n=u.oobCode)!==null&&n!==void 0?n:null,m=pI((i=u.mode)!==null&&i!==void 0?i:null);q(h&&f&&m,"argument-error"),this.apiKey=h,this.operation=m,this.code=f,this.continueUrl=(s=u.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=u.lang)!==null&&o!==void 0?o:null,this.tenantId=(c=u.tenantId)!==null&&c!==void 0?c:null}static parseLink(e){const t=mI(e);try{return new bc(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wr{constructor(){this.providerId=wr.PROVIDER_ID}static credential(e,t){return Ii._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=bc.parseLink(t);return q(n,"argument-error"),Ii._fromEmailAndCode(e,n.code,n.tenantId)}}wr.PROVIDER_ID="password";wr.EMAIL_PASSWORD_SIGN_IN_METHOD="password";wr.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tf(r,e,t=!1){const{auth:n}=r;if(Oe(n.app))return Promise.reject(_t(n));const i="reauthenticate";try{const s=await Pn(r,Ef(n,i,e,r),t);q(s.idToken,n,"internal-error");const o=wc(s.idToken);q(o,n,"internal-error");const{sub:c}=o;return q(r.uid===c,n,"user-mismatch"),Cn._forOperation(r,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&We(n,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Af(r){const e=Rt(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function qA(r,e,t){const n=Rt(r),i={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&wf(n,i,t),await Hs(n,i,"getOobCode",lI)}async function $A(r,e,t){if(Oe(r.app))return Promise.reject(_t(r));const n=Rt(r),o=await Hs(n,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",gI).catch(u=>{throw u.code==="auth/password-does-not-meet-requirements"&&Af(r),u}),c=await Cn._fromIdTokenResponse(n,"signIn",o);return await n._updateCurrentUser(c.user),c}function zA(r,e,t){return Oe(r.app)?Promise.reject(_t(r)):yI(ee(r),wr.credential(e,t)).catch(async n=>{throw n.code==="auth/password-does-not-meet-requirements"&&Af(r),n})}async function KA(r,e){const t=ee(r),i={requestType:"VERIFY_EMAIL",idToken:await r.getIdToken()};e&&wf(t.auth,i,e);const{email:s}=await uI(t.auth,i);s!==r.email&&await r.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sc(r,e){return e?mt(e):(q(r._popupRedirectResolver,r,"argument-error"),r._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cc extends Rc{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return rr(e,this._buildIdpRequest())}_linkToIdToken(e,t){return rr(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return rr(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function FI(r){return vf(r.auth,new Cc(r),r.bypassAuthState)}function UI(r){const{auth:e,user:t}=r;return q(t,e,"internal-error"),Tf(t,new Cc(r),r.bypassAuthState)}async function BI(r){const{auth:e,user:t}=r;return q(t,e,"internal-error"),_I(t,new Cc(r),r.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rE=new Mi(3e4,6e4);function eh(){const r=it().___jsl;if(r!=null&&r.H){for(const e of Object.keys(r.H))if(r.H[e].r=r.H[e].r||[],r.H[e].L=r.H[e].L||[],r.H[e].r=[...r.H[e].L],r.CP)for(let t=0;t<r.CP.length;t++)r.CP[t]=null}}function iE(r){return new Promise((e,t)=>{var n,i,s;function o(){eh(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{eh(),t(Ge(r,"network-request-failed"))},timeout:rE.get()})}if(!((i=(n=it().gapi)===null||n===void 0?void 0:n.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=it().gapi)===null||s===void 0)&&s.load)o();else{const c=Xy("iframefcb");return it()[c]=()=>{gapi.load?o():t(Ge(r,"network-request-failed"))},gf(`${Qy()}?onload=${c}`).catch(u=>t(u))}}).catch(e=>{throw Vs=null,e})}let Vs=null;function sE(r){return Vs=Vs||iE(r),Vs}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fE={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},pE=500,mE=600,gE="_blank",_E="http://localhost";class th{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function yE(r,e,t,n=pE,i=mE){const s=Math.max((window.screen.availHeight-i)/2,0).toString(),o=Math.max((window.screen.availWidth-n)/2,0).toString();let c="";const u=Object.assign(Object.assign({},fE),{width:n.toString(),height:i.toString(),top:s,left:o}),h=ye().toLowerCase();t&&(c=uf(h)?gE:t),af(h)&&(e=e||_E,u.scrollbars="yes");const f=Object.entries(u).reduce((g,[b,C])=>`${g}${b}=${C},`,"");if(By(h)&&c!=="_self")return IE(e||"",c),new th(null);const m=window.open(e||"",c,f);q(m,r,"popup-blocked");try{m.focus()}catch{}return new th(m)}function IE(r,e){const t=document.createElement("a");t.href=r,t.target=e;const n=document.createEvent("MouseEvent");n.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(n)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Mf,ri,Lf,Ds,$a,Ff,Uf,Bf;(function(){var r,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,l,d){return a==Array.prototype||a==Object.prototype||(a[l]=d.value),a};function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Is=="object"&&Is];for(var l=0;l<a.length;++l){var d=a[l];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var n=t(this);function i(a,l){if(l)e:{var d=n;a=a.split(".");for(var p=0;p<a.length-1;p++){var A=a[p];if(!(A in d))break e;d=d[A]}a=a[a.length-1],p=d[a],l=l(p),l!=p&&l!=null&&e(d,a,{configurable:!0,writable:!0,value:l})}}function s(a,l){a instanceof String&&(a+="");var d=0,p=!1,A={next:function(){if(!p&&d<a.length){var P=d++;return{value:l(P,a[P]),done:!1}}return p=!0,{done:!0,value:void 0}}};return A[Symbol.iterator]=function(){return A},A}i("Array.prototype.values",function(a){return a||function(){return s(this,function(l,d){return d})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},c=this||self;function u(a){var l=typeof a;return l=l!="object"?l:a?Array.isArray(a)?"array":l:"null",l=="array"||l=="object"&&typeof a.length=="number"}function h(a){var l=typeof a;return l=="object"&&a!=null||l=="function"}function f(a,l,d){return a.call.apply(a.bind,arguments)}function m(a,l,d){if(!a)throw Error();if(2<arguments.length){var p=Array.prototype.slice.call(arguments,2);return function(){var A=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(A,p),a.apply(l,A)}}return function(){return a.apply(l,arguments)}}function g(a,l,d){return g=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:m,g.apply(null,arguments)}function b(a,l){var d=Array.prototype.slice.call(arguments,1);return function(){var p=d.slice();return p.push.apply(p,arguments),a.apply(this,p)}}function C(a,l){function d(){}d.prototype=l.prototype,a.aa=l.prototype,a.prototype=new d,a.prototype.constructor=a,a.Qb=function(p,A,P){for(var x=Array(arguments.length-2),ie=2;ie<arguments.length;ie++)x[ie-2]=arguments[ie];return l.prototype[A].apply(p,x)}}function k(a){const l=a.length;if(0<l){const d=Array(l);for(let p=0;p<l;p++)d[p]=a[p];return d}return[]}function V(a,l){for(let d=1;d<arguments.length;d++){const p=arguments[d];if(u(p)){const A=a.length||0,P=p.length||0;a.length=A+P;for(let x=0;x<P;x++)a[A+x]=p[x]}else a.push(p)}}class ${constructor(l,d){this.i=l,this.j=d,this.h=0,this.g=null}get(){let l;return 0<this.h?(this.h--,l=this.g,this.g=l.next,l.next=null):l=this.i(),l}}function j(a){return/^[\s\xa0]*$/.test(a)}function L(){var a=c.navigator;return a&&(a=a.userAgent)?a:""}function K(a){return K[" "](a),a}K[" "]=function(){};var X=L().indexOf("Gecko")!=-1&&!(L().toLowerCase().indexOf("webkit")!=-1&&L().indexOf("Edge")==-1)&&!(L().indexOf("Trident")!=-1||L().indexOf("MSIE")!=-1)&&L().indexOf("Edge")==-1;function G(a,l,d){for(const p in a)l.call(d,a[p],p,a)}function E(a,l){for(const d in a)l.call(void 0,a[d],d,a)}function _(a){const l={};for(const d in a)l[d]=a[d];return l}const I="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function T(a,l){let d,p;for(let A=1;A<arguments.length;A++){p=arguments[A];for(d in p)a[d]=p[d];for(let P=0;P<I.length;P++)d=I[P],Object.prototype.hasOwnProperty.call(p,d)&&(a[d]=p[d])}}function v(a){var l=1;a=a.split(":");const d=[];for(;0<l&&a.length;)d.push(a.shift()),l--;return a.length&&d.push(a.join(":")),d}function R(a){c.setTimeout(()=>{throw a},0)}function y(){var a=Qo;let l=null;return a.g&&(l=a.g,a.g=a.g.next,a.g||(a.h=null),l.next=null),l}class ht{constructor(){this.h=this.g=null}add(l,d){const p=Nr.get();p.set(l,d),this.h?this.h.next=p:this.g=p,this.h=p}}var Nr=new $(()=>new sg,a=>a.reset());class sg{constructor(){this.next=this.g=this.h=null}set(l,d){this.h=l,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let xr,Or=!1,Qo=new ht,Vu=()=>{const a=c.Promise.resolve(void 0);xr=()=>{a.then(og)}};var og=()=>{for(var a;a=y();){try{a.h.call(a.g)}catch(d){R(d)}var l=Nr;l.j(a),100>l.h&&(l.h++,a.next=l.g,l.g=a)}Or=!1};function St(){this.s=this.s,this.C=this.C}St.prototype.s=!1,St.prototype.ma=function(){this.s||(this.s=!0,this.N())},St.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function Re(a,l){this.type=a,this.g=this.target=l,this.defaultPrevented=!1}Re.prototype.h=function(){this.defaultPrevented=!0};var ag=(function(){if(!c.addEventListener||!Object.defineProperty)return!1;var a=!1,l=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};c.addEventListener("test",d,l),c.removeEventListener("test",d,l)}catch{}return a})();function Mr(a,l){if(Re.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var d=this.type=a.type,p=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=l,l=a.relatedTarget){if(X){e:{try{K(l.nodeName);var A=!0;break e}catch{}A=!1}A||(l=null)}}else d=="mouseover"?l=a.fromElement:d=="mouseout"&&(l=a.toElement);this.relatedTarget=l,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:cg[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&Mr.aa.h.call(this)}}C(Mr,Re);var cg={2:"touch",3:"pen",4:"mouse"};Mr.prototype.h=function(){Mr.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var Zi="closure_listenable_"+(1e6*Math.random()|0),ug=0;function lg(a,l,d,p,A){this.listener=a,this.proxy=null,this.src=l,this.type=d,this.capture=!!p,this.ha=A,this.key=++ug,this.da=this.fa=!1}function es(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function ts(a){this.src=a,this.g={},this.h=0}ts.prototype.add=function(a,l,d,p,A){var P=a.toString();a=this.g[P],a||(a=this.g[P]=[],this.h++);var x=Jo(a,l,p,A);return-1<x?(l=a[x],d||(l.fa=!1)):(l=new lg(l,this.src,P,!!p,A),l.fa=d,a.push(l)),l};function Xo(a,l){var d=l.type;if(d in a.g){var p=a.g[d],A=Array.prototype.indexOf.call(p,l,void 0),P;(P=0<=A)&&Array.prototype.splice.call(p,A,1),P&&(es(l),a.g[d].length==0&&(delete a.g[d],a.h--))}}function Jo(a,l,d,p){for(var A=0;A<a.length;++A){var P=a[A];if(!P.da&&P.listener==l&&P.capture==!!d&&P.ha==p)return A}return-1}var Yo="closure_lm_"+(1e6*Math.random()|0),Zo={};function Du(a,l,d,p,A){if(Array.isArray(l)){for(var P=0;P<l.length;P++)Du(a,l[P],d,p,A);return null}return d=xu(d),a&&a[Zi]?a.K(l,d,h(p)?!!p.capture:!1,A):hg(a,l,d,!1,p,A)}function hg(a,l,d,p,A,P){if(!l)throw Error("Invalid event type");var x=h(A)?!!A.capture:!!A,ie=ta(a);if(ie||(a[Yo]=ie=new ts(a)),d=ie.add(l,d,p,x,P),d.proxy)return d;if(p=dg(),d.proxy=p,p.src=a,p.listener=d,a.addEventListener)ag||(A=x),A===void 0&&(A=!1),a.addEventListener(l.toString(),p,A);else if(a.attachEvent)a.attachEvent(Nu(l.toString()),p);else if(a.addListener&&a.removeListener)a.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return d}function dg(){function a(d){return l.call(a.src,a.listener,d)}const l=fg;return a}function ku(a,l,d,p,A){if(Array.isArray(l))for(var P=0;P<l.length;P++)ku(a,l[P],d,p,A);else p=h(p)?!!p.capture:!!p,d=xu(d),a&&a[Zi]?(a=a.i,l=String(l).toString(),l in a.g&&(P=a.g[l],d=Jo(P,d,p,A),-1<d&&(es(P[d]),Array.prototype.splice.call(P,d,1),P.length==0&&(delete a.g[l],a.h--)))):a&&(a=ta(a))&&(l=a.g[l.toString()],a=-1,l&&(a=Jo(l,d,p,A)),(d=-1<a?l[a]:null)&&ea(d))}function ea(a){if(typeof a!="number"&&a&&!a.da){var l=a.src;if(l&&l[Zi])Xo(l.i,a);else{var d=a.type,p=a.proxy;l.removeEventListener?l.removeEventListener(d,p,a.capture):l.detachEvent?l.detachEvent(Nu(d),p):l.addListener&&l.removeListener&&l.removeListener(p),(d=ta(l))?(Xo(d,a),d.h==0&&(d.src=null,l[Yo]=null)):es(a)}}}function Nu(a){return a in Zo?Zo[a]:Zo[a]="on"+a}function fg(a,l){if(a.da)a=!0;else{l=new Mr(l,this);var d=a.listener,p=a.ha||a.src;a.fa&&ea(a),a=d.call(p,l)}return a}function ta(a){return a=a[Yo],a instanceof ts?a:null}var na="__closure_events_fn_"+(1e9*Math.random()>>>0);function xu(a){return typeof a=="function"?a:(a[na]||(a[na]=function(l){return a.handleEvent(l)}),a[na])}function be(){St.call(this),this.i=new ts(this),this.M=this,this.F=null}C(be,St),be.prototype[Zi]=!0,be.prototype.removeEventListener=function(a,l,d,p){ku(this,a,l,d,p)};function Ne(a,l){var d,p=a.F;if(p)for(d=[];p;p=p.F)d.push(p);if(a=a.M,p=l.type||l,typeof l=="string")l=new Re(l,a);else if(l instanceof Re)l.target=l.target||a;else{var A=l;l=new Re(p,a),T(l,A)}if(A=!0,d)for(var P=d.length-1;0<=P;P--){var x=l.g=d[P];A=ns(x,p,!0,l)&&A}if(x=l.g=a,A=ns(x,p,!0,l)&&A,A=ns(x,p,!1,l)&&A,d)for(P=0;P<d.length;P++)x=l.g=d[P],A=ns(x,p,!1,l)&&A}be.prototype.N=function(){if(be.aa.N.call(this),this.i){var a=this.i,l;for(l in a.g){for(var d=a.g[l],p=0;p<d.length;p++)es(d[p]);delete a.g[l],a.h--}}this.F=null},be.prototype.K=function(a,l,d,p){return this.i.add(String(a),l,!1,d,p)},be.prototype.L=function(a,l,d,p){return this.i.add(String(a),l,!0,d,p)};function ns(a,l,d,p){if(l=a.i.g[String(l)],!l)return!0;l=l.concat();for(var A=!0,P=0;P<l.length;++P){var x=l[P];if(x&&!x.da&&x.capture==d){var ie=x.listener,ve=x.ha||x.src;x.fa&&Xo(a.i,x),A=ie.call(ve,p)!==!1&&A}}return A&&!p.defaultPrevented}function Ou(a,l,d){if(typeof a=="function")d&&(a=g(a,d));else if(a&&typeof a.handleEvent=="function")a=g(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(l)?-1:c.setTimeout(a,l||0)}function Mu(a){a.g=Ou(()=>{a.g=null,a.i&&(a.i=!1,Mu(a))},a.l);const l=a.h;a.h=null,a.m.apply(null,l)}class pg extends St{constructor(l,d){super(),this.m=l,this.l=d,this.h=null,this.i=!1,this.g=null}j(l){this.h=arguments,this.g?this.i=!0:Mu(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Lr(a){St.call(this),this.h=a,this.g={}}C(Lr,St);var Lu=[];function Fu(a){G(a.g,function(l,d){this.g.hasOwnProperty(d)&&ea(l)},a),a.g={}}Lr.prototype.N=function(){Lr.aa.N.call(this),Fu(this)},Lr.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ra=c.JSON.stringify,mg=c.JSON.parse,gg=class{stringify(a){return c.JSON.stringify(a,void 0)}parse(a){return c.JSON.parse(a,void 0)}};function ia(){}ia.prototype.h=null;function Uu(a){return a.h||(a.h=a.i())}function Bu(){}var Fr={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function sa(){Re.call(this,"d")}C(sa,Re);function oa(){Re.call(this,"c")}C(oa,Re);var un={},ju=null;function rs(){return ju=ju||new be}un.La="serverreachability";function qu(a){Re.call(this,un.La,a)}C(qu,Re);function Ur(a){const l=rs();Ne(l,new qu(l))}un.STAT_EVENT="statevent";function $u(a,l){Re.call(this,un.STAT_EVENT,a),this.stat=l}C($u,Re);function xe(a){const l=rs();Ne(l,new $u(l,a))}un.Ma="timingevent";function zu(a,l){Re.call(this,un.Ma,a),this.size=l}C(zu,Re);function Br(a,l){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){a()},l)}function jr(){this.g=!0}jr.prototype.xa=function(){this.g=!1};function _g(a,l,d,p,A,P){a.info(function(){if(a.g)if(P)for(var x="",ie=P.split("&"),ve=0;ve<ie.length;ve++){var Z=ie[ve].split("=");if(1<Z.length){var Pe=Z[0];Z=Z[1];var Se=Pe.split("_");x=2<=Se.length&&Se[1]=="type"?x+(Pe+"="+Z+"&"):x+(Pe+"=redacted&")}}else x=null;else x=P;return"XMLHTTP REQ ("+p+") [attempt "+A+"]: "+l+`
`+d+`
`+x})}function yg(a,l,d,p,A,P,x){a.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+A+"]: "+l+`
`+d+`
`+P+" "+x})}function Bn(a,l,d,p){a.info(function(){return"XMLHTTP TEXT ("+l+"): "+Eg(a,d)+(p?" "+p:"")})}function Ig(a,l){a.info(function(){return"TIMEOUT: "+l})}jr.prototype.info=function(){};function Eg(a,l){if(!a.g)return l;if(!l)return null;try{var d=JSON.parse(l);if(d){for(a=0;a<d.length;a++)if(Array.isArray(d[a])){var p=d[a];if(!(2>p.length)){var A=p[1];if(Array.isArray(A)&&!(1>A.length)){var P=A[0];if(P!="noop"&&P!="stop"&&P!="close")for(var x=1;x<A.length;x++)A[x]=""}}}}return ra(d)}catch{return l}}var is={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Ku={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},aa;function ss(){}C(ss,ia),ss.prototype.g=function(){return new XMLHttpRequest},ss.prototype.i=function(){return{}},aa=new ss;function Ct(a,l,d,p){this.j=a,this.i=l,this.l=d,this.R=p||1,this.U=new Lr(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Gu}function Gu(){this.i=null,this.g="",this.h=!1}var Wu={},ca={};function ua(a,l,d){a.L=1,a.v=us(dt(l)),a.m=d,a.P=!0,Hu(a,null)}function Hu(a,l){a.F=Date.now(),os(a),a.A=dt(a.v);var d=a.A,p=a.R;Array.isArray(p)||(p=[String(p)]),cl(d.i,"t",p),a.C=0,d=a.j.J,a.h=new Gu,a.g=bl(a.j,d?l:null,!a.m),0<a.O&&(a.M=new pg(g(a.Y,a,a.g),a.O)),l=a.U,d=a.g,p=a.ca;var A="readystatechange";Array.isArray(A)||(A&&(Lu[0]=A.toString()),A=Lu);for(var P=0;P<A.length;P++){var x=Du(d,A[P],p||l.handleEvent,!1,l.h||l);if(!x)break;l.g[x.key]=x}l=a.H?_(a.H):{},a.m?(a.u||(a.u="POST"),l["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,l)):(a.u="GET",a.g.ea(a.A,a.u,null,l)),Ur(),_g(a.i,a.u,a.A,a.l,a.R,a.m)}Ct.prototype.ca=function(a){a=a.target;const l=this.M;l&&ft(a)==3?l.j():this.Y(a)},Ct.prototype.Y=function(a){try{if(a==this.g)e:{const Se=ft(this.g);var l=this.g.Ba();const $n=this.g.Z();if(!(3>Se)&&(Se!=3||this.g&&(this.h.h||this.g.oa()||ml(this.g)))){this.J||Se!=4||l==7||(l==8||0>=$n?Ur(3):Ur(2)),la(this);var d=this.g.Z();this.X=d;t:if(Qu(this)){var p=ml(this.g);a="";var A=p.length,P=ft(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){ln(this),qr(this);var x="";break t}this.h.i=new c.TextDecoder}for(l=0;l<A;l++)this.h.h=!0,a+=this.h.i.decode(p[l],{stream:!(P&&l==A-1)});p.length=0,this.h.g+=a,this.C=0,x=this.h.g}else x=this.g.oa();if(this.o=d==200,yg(this.i,this.u,this.A,this.l,this.R,Se,d),this.o){if(this.T&&!this.K){t:{if(this.g){var ie,ve=this.g;if((ie=ve.g?ve.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!j(ie)){var Z=ie;break t}}Z=null}if(d=Z)Bn(this.i,this.l,d,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,ha(this,d);else{this.o=!1,this.s=3,xe(12),ln(this),qr(this);break e}}if(this.P){d=!0;let He;for(;!this.J&&this.C<x.length;)if(He=Tg(this,x),He==ca){Se==4&&(this.s=4,xe(14),d=!1),Bn(this.i,this.l,null,"[Incomplete Response]");break}else if(He==Wu){this.s=4,xe(15),Bn(this.i,this.l,x,"[Invalid Chunk]"),d=!1;break}else Bn(this.i,this.l,He,null),ha(this,He);if(Qu(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Se!=4||x.length!=0||this.h.h||(this.s=1,xe(16),d=!1),this.o=this.o&&d,!d)Bn(this.i,this.l,x,"[Invalid Chunked Response]"),ln(this),qr(this);else if(0<x.length&&!this.W){this.W=!0;var Pe=this.j;Pe.g==this&&Pe.ba&&!Pe.M&&(Pe.j.info("Great, no buffering proxy detected. Bytes received: "+x.length),_a(Pe),Pe.M=!0,xe(11))}}else Bn(this.i,this.l,x,null),ha(this,x);Se==4&&ln(this),this.o&&!this.J&&(Se==4?vl(this.j,this):(this.o=!1,os(this)))}else Fg(this.g),d==400&&0<x.indexOf("Unknown SID")?(this.s=3,xe(12)):(this.s=0,xe(13)),ln(this),qr(this)}}}catch{}finally{}};function Qu(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function Tg(a,l){var d=a.C,p=l.indexOf(`
`,d);return p==-1?ca:(d=Number(l.substring(d,p)),isNaN(d)?Wu:(p+=1,p+d>l.length?ca:(l=l.slice(p,p+d),a.C=p+d,l)))}Ct.prototype.cancel=function(){this.J=!0,ln(this)};function os(a){a.S=Date.now()+a.I,Xu(a,a.I)}function Xu(a,l){if(a.B!=null)throw Error("WatchDog timer not null");a.B=Br(g(a.ba,a),l)}function la(a){a.B&&(c.clearTimeout(a.B),a.B=null)}Ct.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(Ig(this.i,this.A),this.L!=2&&(Ur(),xe(17)),ln(this),this.s=2,qr(this)):Xu(this,this.S-a)};function qr(a){a.j.G==0||a.J||vl(a.j,a)}function ln(a){la(a);var l=a.M;l&&typeof l.ma=="function"&&l.ma(),a.M=null,Fu(a.U),a.g&&(l=a.g,a.g=null,l.abort(),l.ma())}function ha(a,l){try{var d=a.j;if(d.G!=0&&(d.g==a||da(d.h,a))){if(!a.K&&da(d.h,a)&&d.G==3){try{var p=d.Da.g.parse(l)}catch{p=null}if(Array.isArray(p)&&p.length==3){var A=p;if(A[0]==0){e:if(!d.u){if(d.g)if(d.g.F+3e3<a.F)ms(d),fs(d);else break e;ga(d),xe(18)}}else d.za=A[1],0<d.za-d.T&&37500>A[2]&&d.F&&d.v==0&&!d.C&&(d.C=Br(g(d.Za,d),6e3));if(1>=Zu(d.h)&&d.ca){try{d.ca()}catch{}d.ca=void 0}}else dn(d,11)}else if((a.K||d.g==a)&&ms(d),!j(l))for(A=d.Da.g.parse(l),l=0;l<A.length;l++){let Z=A[l];if(d.T=Z[0],Z=Z[1],d.G==2)if(Z[0]=="c"){d.K=Z[1],d.ia=Z[2];const Pe=Z[3];Pe!=null&&(d.la=Pe,d.j.info("VER="+d.la));const Se=Z[4];Se!=null&&(d.Aa=Se,d.j.info("SVER="+d.Aa));const $n=Z[5];$n!=null&&typeof $n=="number"&&0<$n&&(p=1.5*$n,d.L=p,d.j.info("backChannelRequestTimeoutMs_="+p)),p=d;const He=a.g;if(He){const _s=He.g?He.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(_s){var P=p.h;P.g||_s.indexOf("spdy")==-1&&_s.indexOf("quic")==-1&&_s.indexOf("h2")==-1||(P.j=P.l,P.g=new Set,P.h&&(fa(P,P.h),P.h=null))}if(p.D){const ya=He.g?He.g.getResponseHeader("X-HTTP-Session-Id"):null;ya&&(p.ya=ya,oe(p.I,p.D,ya))}}d.G=3,d.l&&d.l.ua(),d.ba&&(d.R=Date.now()-a.F,d.j.info("Handshake RTT: "+d.R+"ms")),p=d;var x=a;if(p.qa=Rl(p,p.J?p.ia:null,p.W),x.K){el(p.h,x);var ie=x,ve=p.L;ve&&(ie.I=ve),ie.B&&(la(ie),os(ie)),p.g=x}else El(p);0<d.i.length&&ps(d)}else Z[0]!="stop"&&Z[0]!="close"||dn(d,7);else d.G==3&&(Z[0]=="stop"||Z[0]=="close"?Z[0]=="stop"?dn(d,7):ma(d):Z[0]!="noop"&&d.l&&d.l.ta(Z),d.v=0)}}Ur(4)}catch{}}var vg=class{constructor(a,l){this.g=a,this.map=l}};function Ju(a){this.l=a||10,c.PerformanceNavigationTiming?(a=c.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Yu(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Zu(a){return a.h?1:a.g?a.g.size:0}function da(a,l){return a.h?a.h==l:a.g?a.g.has(l):!1}function fa(a,l){a.g?a.g.add(l):a.h=l}function el(a,l){a.h&&a.h==l?a.h=null:a.g&&a.g.has(l)&&a.g.delete(l)}Ju.prototype.cancel=function(){if(this.i=tl(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function tl(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let l=a.i;for(const d of a.g.values())l=l.concat(d.D);return l}return k(a.i)}function wg(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(u(a)){for(var l=[],d=a.length,p=0;p<d;p++)l.push(a[p]);return l}l=[],d=0;for(p in a)l[d++]=a[p];return l}function Ag(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(u(a)||typeof a=="string"){var l=[];a=a.length;for(var d=0;d<a;d++)l.push(d);return l}l=[],d=0;for(const p in a)l[d++]=p;return l}}}function nl(a,l){if(a.forEach&&typeof a.forEach=="function")a.forEach(l,void 0);else if(u(a)||typeof a=="string")Array.prototype.forEach.call(a,l,void 0);else for(var d=Ag(a),p=wg(a),A=p.length,P=0;P<A;P++)l.call(void 0,p[P],d&&d[P],a)}var rl=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Rg(a,l){if(a){a=a.split("&");for(var d=0;d<a.length;d++){var p=a[d].indexOf("="),A=null;if(0<=p){var P=a[d].substring(0,p);A=a[d].substring(p+1)}else P=a[d];l(P,A?decodeURIComponent(A.replace(/\+/g," ")):"")}}}function hn(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof hn){this.h=a.h,as(this,a.j),this.o=a.o,this.g=a.g,cs(this,a.s),this.l=a.l;var l=a.i,d=new Kr;d.i=l.i,l.g&&(d.g=new Map(l.g),d.h=l.h),il(this,d),this.m=a.m}else a&&(l=String(a).match(rl))?(this.h=!1,as(this,l[1]||"",!0),this.o=$r(l[2]||""),this.g=$r(l[3]||"",!0),cs(this,l[4]),this.l=$r(l[5]||"",!0),il(this,l[6]||"",!0),this.m=$r(l[7]||"")):(this.h=!1,this.i=new Kr(null,this.h))}hn.prototype.toString=function(){var a=[],l=this.j;l&&a.push(zr(l,sl,!0),":");var d=this.g;return(d||l=="file")&&(a.push("//"),(l=this.o)&&a.push(zr(l,sl,!0),"@"),a.push(encodeURIComponent(String(d)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.s,d!=null&&a.push(":",String(d))),(d=this.l)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(zr(d,d.charAt(0)=="/"?Sg:Pg,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",zr(d,Vg)),a.join("")};function dt(a){return new hn(a)}function as(a,l,d){a.j=d?$r(l,!0):l,a.j&&(a.j=a.j.replace(/:$/,""))}function cs(a,l){if(l){if(l=Number(l),isNaN(l)||0>l)throw Error("Bad port number "+l);a.s=l}else a.s=null}function il(a,l,d){l instanceof Kr?(a.i=l,Dg(a.i,a.h)):(d||(l=zr(l,Cg)),a.i=new Kr(l,a.h))}function oe(a,l,d){a.i.set(l,d)}function us(a){return oe(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function $r(a,l){return a?l?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function zr(a,l,d){return typeof a=="string"?(a=encodeURI(a).replace(l,bg),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function bg(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var sl=/[#\/\?@]/g,Pg=/[#\?:]/g,Sg=/[#\?]/g,Cg=/[#\?@]/g,Vg=/#/g;function Kr(a,l){this.h=this.g=null,this.i=a||null,this.j=!!l}function Vt(a){a.g||(a.g=new Map,a.h=0,a.i&&Rg(a.i,function(l,d){a.add(decodeURIComponent(l.replace(/\+/g," ")),d)}))}r=Kr.prototype,r.add=function(a,l){Vt(this),this.i=null,a=jn(this,a);var d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(l),this.h+=1,this};function ol(a,l){Vt(a),l=jn(a,l),a.g.has(l)&&(a.i=null,a.h-=a.g.get(l).length,a.g.delete(l))}function al(a,l){return Vt(a),l=jn(a,l),a.g.has(l)}r.forEach=function(a,l){Vt(this),this.g.forEach(function(d,p){d.forEach(function(A){a.call(l,A,p,this)},this)},this)},r.na=function(){Vt(this);const a=Array.from(this.g.values()),l=Array.from(this.g.keys()),d=[];for(let p=0;p<l.length;p++){const A=a[p];for(let P=0;P<A.length;P++)d.push(l[p])}return d},r.V=function(a){Vt(this);let l=[];if(typeof a=="string")al(this,a)&&(l=l.concat(this.g.get(jn(this,a))));else{a=Array.from(this.g.values());for(let d=0;d<a.length;d++)l=l.concat(a[d])}return l},r.set=function(a,l){return Vt(this),this.i=null,a=jn(this,a),al(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[l]),this.h+=1,this},r.get=function(a,l){return a?(a=this.V(a),0<a.length?String(a[0]):l):l};function cl(a,l,d){ol(a,l),0<d.length&&(a.i=null,a.g.set(jn(a,l),k(d)),a.h+=d.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],l=Array.from(this.g.keys());for(var d=0;d<l.length;d++){var p=l[d];const P=encodeURIComponent(String(p)),x=this.V(p);for(p=0;p<x.length;p++){var A=P;x[p]!==""&&(A+="="+encodeURIComponent(String(x[p]))),a.push(A)}}return this.i=a.join("&")};function jn(a,l){return l=String(l),a.j&&(l=l.toLowerCase()),l}function Dg(a,l){l&&!a.j&&(Vt(a),a.i=null,a.g.forEach(function(d,p){var A=p.toLowerCase();p!=A&&(ol(this,p),cl(this,A,d))},a)),a.j=l}function kg(a,l){const d=new jr;if(c.Image){const p=new Image;p.onload=b(Dt,d,"TestLoadImage: loaded",!0,l,p),p.onerror=b(Dt,d,"TestLoadImage: error",!1,l,p),p.onabort=b(Dt,d,"TestLoadImage: abort",!1,l,p),p.ontimeout=b(Dt,d,"TestLoadImage: timeout",!1,l,p),c.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=a}else l(!1)}function Ng(a,l){const d=new jr,p=new AbortController,A=setTimeout(()=>{p.abort(),Dt(d,"TestPingServer: timeout",!1,l)},1e4);fetch(a,{signal:p.signal}).then(P=>{clearTimeout(A),P.ok?Dt(d,"TestPingServer: ok",!0,l):Dt(d,"TestPingServer: server error",!1,l)}).catch(()=>{clearTimeout(A),Dt(d,"TestPingServer: error",!1,l)})}function Dt(a,l,d,p,A){try{A&&(A.onload=null,A.onerror=null,A.onabort=null,A.ontimeout=null),p(d)}catch{}}function xg(){this.g=new gg}function Og(a,l,d){const p=d||"";try{nl(a,function(A,P){let x=A;h(A)&&(x=ra(A)),l.push(p+P+"="+encodeURIComponent(x))})}catch(A){throw l.push(p+"type="+encodeURIComponent("_badmap")),A}}function ls(a){this.l=a.Ub||null,this.j=a.eb||!1}C(ls,ia),ls.prototype.g=function(){return new hs(this.l,this.j)},ls.prototype.i=(function(a){return function(){return a}})({});function hs(a,l){be.call(this),this.D=a,this.o=l,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}C(hs,be),r=hs.prototype,r.open=function(a,l){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=l,this.readyState=1,Wr(this)},r.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const l={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(l.body=a),(this.D||c).fetch(new Request(this.A,l)).then(this.Sa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Gr(this)),this.readyState=0},r.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Wr(this)),this.g&&(this.readyState=3,Wr(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;ul(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function ul(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}r.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var l=a.value?a.value:new Uint8Array(0);(l=this.v.decode(l,{stream:!a.done}))&&(this.response=this.responseText+=l)}a.done?Gr(this):Wr(this),this.readyState==3&&ul(this)}},r.Ra=function(a){this.g&&(this.response=this.responseText=a,Gr(this))},r.Qa=function(a){this.g&&(this.response=a,Gr(this))},r.ga=function(){this.g&&Gr(this)};function Gr(a){a.readyState=4,a.l=null,a.j=null,a.v=null,Wr(a)}r.setRequestHeader=function(a,l){this.u.append(a,l)},r.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],l=this.h.entries();for(var d=l.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=l.next();return a.join(`\r
`)};function Wr(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(hs.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function ll(a){let l="";return G(a,function(d,p){l+=p,l+=":",l+=d,l+=`\r
`}),l}function pa(a,l,d){e:{for(p in d){var p=!1;break e}p=!0}p||(d=ll(d),typeof a=="string"?d!=null&&encodeURIComponent(String(d)):oe(a,l,d))}function de(a){be.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}C(de,be);var Mg=/^https?$/i,Lg=["POST","PUT"];r=de.prototype,r.Ha=function(a){this.J=a},r.ea=function(a,l,d,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);l=l?l.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():aa.g(),this.v=this.o?Uu(this.o):Uu(aa),this.g.onreadystatechange=g(this.Ea,this);try{this.B=!0,this.g.open(l,String(a),!0),this.B=!1}catch(P){hl(this,P);return}if(a=d||"",d=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var A in p)d.set(A,p[A]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const P of p.keys())d.set(P,p.get(P));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(d.keys()).find(P=>P.toLowerCase()=="content-type"),A=c.FormData&&a instanceof c.FormData,!(0<=Array.prototype.indexOf.call(Lg,l,void 0))||p||A||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[P,x]of d)this.g.setRequestHeader(P,x);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{pl(this),this.u=!0,this.g.send(a),this.u=!1}catch(P){hl(this,P)}};function hl(a,l){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=l,a.m=5,dl(a),ds(a)}function dl(a){a.A||(a.A=!0,Ne(a,"complete"),Ne(a,"error"))}r.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,Ne(this,"complete"),Ne(this,"abort"),ds(this))},r.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ds(this,!0)),de.aa.N.call(this)},r.Ea=function(){this.s||(this.B||this.u||this.j?fl(this):this.bb())},r.bb=function(){fl(this)};function fl(a){if(a.h&&typeof o<"u"&&(!a.v[1]||ft(a)!=4||a.Z()!=2)){if(a.u&&ft(a)==4)Ou(a.Ea,0,a);else if(Ne(a,"readystatechange"),ft(a)==4){a.h=!1;try{const x=a.Z();e:switch(x){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var l=!0;break e;default:l=!1}var d;if(!(d=l)){var p;if(p=x===0){var A=String(a.D).match(rl)[1]||null;!A&&c.self&&c.self.location&&(A=c.self.location.protocol.slice(0,-1)),p=!Mg.test(A?A.toLowerCase():"")}d=p}if(d)Ne(a,"complete"),Ne(a,"success");else{a.m=6;try{var P=2<ft(a)?a.g.statusText:""}catch{P=""}a.l=P+" ["+a.Z()+"]",dl(a)}}finally{ds(a)}}}}function ds(a,l){if(a.g){pl(a);const d=a.g,p=a.v[0]?()=>{}:null;a.g=null,a.v=null,l||Ne(a,"ready");try{d.onreadystatechange=p}catch{}}}function pl(a){a.I&&(c.clearTimeout(a.I),a.I=null)}r.isActive=function(){return!!this.g};function ft(a){return a.g?a.g.readyState:0}r.Z=function(){try{return 2<ft(this)?this.g.status:-1}catch{return-1}},r.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},r.Oa=function(a){if(this.g){var l=this.g.responseText;return a&&l.indexOf(a)==0&&(l=l.substring(a.length)),mg(l)}};function ml(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function Fg(a){const l={};a=(a.g&&2<=ft(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<a.length;p++){if(j(a[p]))continue;var d=v(a[p]);const A=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const P=l[A]||[];l[A]=P,P.push(d)}E(l,function(p){return p.join(", ")})}r.Ba=function(){return this.m},r.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Hr(a,l,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||l}function gl(a){this.Aa=0,this.i=[],this.j=new jr,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Hr("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Hr("baseRetryDelayMs",5e3,a),this.cb=Hr("retryDelaySeedMs",1e4,a),this.Wa=Hr("forwardChannelMaxRetries",2,a),this.wa=Hr("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new Ju(a&&a.concurrentRequestLimit),this.Da=new xg,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}r=gl.prototype,r.la=8,r.G=1,r.connect=function(a,l,d,p){xe(0),this.W=a,this.H=l||{},d&&p!==void 0&&(this.H.OSID=d,this.H.OAID=p),this.F=this.X,this.I=Rl(this,null,this.W),ps(this)};function ma(a){if(_l(a),a.G==3){var l=a.U++,d=dt(a.I);if(oe(d,"SID",a.K),oe(d,"RID",l),oe(d,"TYPE","terminate"),Qr(a,d),l=new Ct(a,a.j,l),l.L=2,l.v=us(dt(d)),d=!1,c.navigator&&c.navigator.sendBeacon)try{d=c.navigator.sendBeacon(l.v.toString(),"")}catch{}!d&&c.Image&&(new Image().src=l.v,d=!0),d||(l.g=bl(l.j,null),l.g.ea(l.v)),l.F=Date.now(),os(l)}Al(a)}function fs(a){a.g&&(_a(a),a.g.cancel(),a.g=null)}function _l(a){fs(a),a.u&&(c.clearTimeout(a.u),a.u=null),ms(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&c.clearTimeout(a.s),a.s=null)}function ps(a){if(!Yu(a.h)&&!a.s){a.s=!0;var l=a.Ga;xr||Vu(),Or||(xr(),Or=!0),Qo.add(l,a),a.B=0}}function Ug(a,l){return Zu(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=l.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=Br(g(a.Ga,a,l),wl(a,a.B)),a.B++,!0)}r.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const A=new Ct(this,this.j,a);let P=this.o;if(this.S&&(P?(P=_(P),T(P,this.S)):P=this.S),this.m!==null||this.O||(A.H=P,P=null),this.P)e:{for(var l=0,d=0;d<this.i.length;d++){t:{var p=this.i[d];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(l+=p,4096<l){l=d;break e}if(l===4096||d===this.i.length-1){l=d+1;break e}}l=1e3}else l=1e3;l=Il(this,A,l),d=dt(this.I),oe(d,"RID",a),oe(d,"CVER",22),this.D&&oe(d,"X-HTTP-Session-Id",this.D),Qr(this,d),P&&(this.O?l="headers="+encodeURIComponent(String(ll(P)))+"&"+l:this.m&&pa(d,this.m,P)),fa(this.h,A),this.Ua&&oe(d,"TYPE","init"),this.P?(oe(d,"$req",l),oe(d,"SID","null"),A.T=!0,ua(A,d,null)):ua(A,d,l),this.G=2}}else this.G==3&&(a?yl(this,a):this.i.length==0||Yu(this.h)||yl(this))};function yl(a,l){var d;l?d=l.l:d=a.U++;const p=dt(a.I);oe(p,"SID",a.K),oe(p,"RID",d),oe(p,"AID",a.T),Qr(a,p),a.m&&a.o&&pa(p,a.m,a.o),d=new Ct(a,a.j,d,a.B+1),a.m===null&&(d.H=a.o),l&&(a.i=l.D.concat(a.i)),l=Il(a,d,1e3),d.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),fa(a.h,d),ua(d,p,l)}function Qr(a,l){a.H&&G(a.H,function(d,p){oe(l,p,d)}),a.l&&nl({},function(d,p){oe(l,p,d)})}function Il(a,l,d){d=Math.min(a.i.length,d);var p=a.l?g(a.l.Na,a.l,a):null;e:{var A=a.i;let P=-1;for(;;){const x=["count="+d];P==-1?0<d?(P=A[0].g,x.push("ofs="+P)):P=0:x.push("ofs="+P);let ie=!0;for(let ve=0;ve<d;ve++){let Z=A[ve].g;const Pe=A[ve].map;if(Z-=P,0>Z)P=Math.max(0,A[ve].g-100),ie=!1;else try{Og(Pe,x,"req"+Z+"_")}catch{p&&p(Pe)}}if(ie){p=x.join("&");break e}}}return a=a.i.splice(0,d),l.D=a,p}function El(a){if(!a.g&&!a.u){a.Y=1;var l=a.Fa;xr||Vu(),Or||(xr(),Or=!0),Qo.add(l,a),a.v=0}}function ga(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=Br(g(a.Fa,a),wl(a,a.v)),a.v++,!0)}r.Fa=function(){if(this.u=null,Tl(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=Br(g(this.ab,this),a)}},r.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,xe(10),fs(this),Tl(this))};function _a(a){a.A!=null&&(c.clearTimeout(a.A),a.A=null)}function Tl(a){a.g=new Ct(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var l=dt(a.qa);oe(l,"RID","rpc"),oe(l,"SID",a.K),oe(l,"AID",a.T),oe(l,"CI",a.F?"0":"1"),!a.F&&a.ja&&oe(l,"TO",a.ja),oe(l,"TYPE","xmlhttp"),Qr(a,l),a.m&&a.o&&pa(l,a.m,a.o),a.L&&(a.g.I=a.L);var d=a.g;a=a.ia,d.L=1,d.v=us(dt(l)),d.m=null,d.P=!0,Hu(d,a)}r.Za=function(){this.C!=null&&(this.C=null,fs(this),ga(this),xe(19))};function ms(a){a.C!=null&&(c.clearTimeout(a.C),a.C=null)}function vl(a,l){var d=null;if(a.g==l){ms(a),_a(a),a.g=null;var p=2}else if(da(a.h,l))d=l.D,el(a.h,l),p=1;else return;if(a.G!=0){if(l.o)if(p==1){d=l.m?l.m.length:0,l=Date.now()-l.F;var A=a.B;p=rs(),Ne(p,new zu(p,d)),ps(a)}else El(a);else if(A=l.s,A==3||A==0&&0<l.X||!(p==1&&Ug(a,l)||p==2&&ga(a)))switch(d&&0<d.length&&(l=a.h,l.i=l.i.concat(d)),A){case 1:dn(a,5);break;case 4:dn(a,10);break;case 3:dn(a,6);break;default:dn(a,2)}}}function wl(a,l){let d=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(d*=2),d*l}function dn(a,l){if(a.j.info("Error code "+l),l==2){var d=g(a.fb,a),p=a.Xa;const A=!p;p=new hn(p||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||as(p,"https"),us(p),A?kg(p.toString(),d):Ng(p.toString(),d)}else xe(2);a.G=0,a.l&&a.l.sa(l),Al(a),_l(a)}r.fb=function(a){a?(this.j.info("Successfully pinged google.com"),xe(2)):(this.j.info("Failed to ping google.com"),xe(1))};function Al(a){if(a.G=0,a.ka=[],a.l){const l=tl(a.h);(l.length!=0||a.i.length!=0)&&(V(a.ka,l),V(a.ka,a.i),a.h.i.length=0,k(a.i),a.i.length=0),a.l.ra()}}function Rl(a,l,d){var p=d instanceof hn?dt(d):new hn(d);if(p.g!="")l&&(p.g=l+"."+p.g),cs(p,p.s);else{var A=c.location;p=A.protocol,l=l?l+"."+A.hostname:A.hostname,A=+A.port;var P=new hn(null);p&&as(P,p),l&&(P.g=l),A&&cs(P,A),d&&(P.l=d),p=P}return d=a.D,l=a.ya,d&&l&&oe(p,d,l),oe(p,"VER",a.la),Qr(a,p),p}function bl(a,l,d){if(l&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return l=a.Ca&&!a.pa?new de(new ls({eb:d})):new de(a.pa),l.Ha(a.J),l}r.isActive=function(){return!!this.l&&this.l.isActive(this)};function Pl(){}r=Pl.prototype,r.ua=function(){},r.ta=function(){},r.sa=function(){},r.ra=function(){},r.isActive=function(){return!0},r.Na=function(){};function gs(){}gs.prototype.g=function(a,l){return new Fe(a,l)};function Fe(a,l){be.call(this),this.g=new gl(l),this.l=a,this.h=l&&l.messageUrlParams||null,a=l&&l.messageHeaders||null,l&&l.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=l&&l.initMessageHeaders||null,l&&l.messageContentType&&(a?a["X-WebChannel-Content-Type"]=l.messageContentType:a={"X-WebChannel-Content-Type":l.messageContentType}),l&&l.va&&(a?a["X-WebChannel-Client-Profile"]=l.va:a={"X-WebChannel-Client-Profile":l.va}),this.g.S=a,(a=l&&l.Sb)&&!j(a)&&(this.g.m=a),this.v=l&&l.supportsCrossDomainXhr||!1,this.u=l&&l.sendRawJson||!1,(l=l&&l.httpSessionIdParam)&&!j(l)&&(this.g.D=l,a=this.h,a!==null&&l in a&&(a=this.h,l in a&&delete a[l])),this.j=new qn(this)}C(Fe,be),Fe.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Fe.prototype.close=function(){ma(this.g)},Fe.prototype.o=function(a){var l=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.u&&(d={},d.__data__=ra(a),a=d);l.i.push(new vg(l.Ya++,a)),l.G==3&&ps(l)},Fe.prototype.N=function(){this.g.l=null,delete this.j,ma(this.g),delete this.g,Fe.aa.N.call(this)};function Sl(a){sa.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var l=a.__sm__;if(l){e:{for(const d in l){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,l=l!==null&&a in l?l[a]:void 0),this.data=l}else this.data=a}C(Sl,sa);function Cl(){oa.call(this),this.status=1}C(Cl,oa);function qn(a){this.g=a}C(qn,Pl),qn.prototype.ua=function(){Ne(this.g,"a")},qn.prototype.ta=function(a){Ne(this.g,new Sl(a))},qn.prototype.sa=function(a){Ne(this.g,new Cl)},qn.prototype.ra=function(){Ne(this.g,"b")},gs.prototype.createWebChannel=gs.prototype.g,Fe.prototype.send=Fe.prototype.o,Fe.prototype.open=Fe.prototype.m,Fe.prototype.close=Fe.prototype.close,Bf=function(){return new gs},Uf=function(){return rs()},Ff=un,$a={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},is.NO_ERROR=0,is.TIMEOUT=8,is.HTTP_ERROR=6,Ds=is,Ku.COMPLETE="complete",Lf=Ku,Bu.EventType=Fr,Fr.OPEN="a",Fr.CLOSE="b",Fr.ERROR="c",Fr.MESSAGE="d",be.prototype.listen=be.prototype.K,ri=Bu,de.prototype.listenOnce=de.prototype.L,de.prototype.getLastError=de.prototype.Ka,de.prototype.getLastErrorCode=de.prototype.Ba,de.prototype.getStatus=de.prototype.Z,de.prototype.getResponseJson=de.prototype.Oa,de.prototype.getResponseText=de.prototype.oa,de.prototype.send=de.prototype.ea,de.prototype.setWithCredentials=de.prototype.Ha,Mf=de}).apply(typeof Is<"u"?Is:typeof self<"u"?self:typeof window<"u"?window:{});const ah="@firebase/firestore",ch="4.8.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vn=new _c("@firebase/firestore");function Xn(){return Vn.logLevel}function D(r,...e){if(Vn.logLevel<=H.DEBUG){const t=e.map(Vc);Vn.debug(`Firestore (${Ar}): ${r}`,...t)}}function fe(r,...e){if(Vn.logLevel<=H.ERROR){const t=e.map(Vc);Vn.error(`Firestore (${Ar}): ${r}`,...t)}}function Jt(r,...e){if(Vn.logLevel<=H.WARN){const t=e.map(Vc);Vn.warn(`Firestore (${Ar}): ${r}`,...t)}}function Vc(r){if(typeof r=="string")return r;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function M(r,e,t){let n="Unexpected state";typeof e=="string"?n=e:t=e,jf(r,n,t)}function jf(r,e,t){let n=`FIRESTORE (${Ar}) INTERNAL ASSERTION FAILED: ${e} (ID: ${r.toString(16)})`;if(t!==void 0)try{n+=" CONTEXT: "+JSON.stringify(t)}catch{n+=" CONTEXT: "+t}throw fe(n),new Error(n)}function U(r,e,t,n){let i="Unexpected state";typeof t=="string"?i=t:n=t,r||jf(e,i,n)}function F(r,e){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gn="remoteDocuments",qi="owner",zn="owner",vi="mutationQueues",HE="userId",Qe="mutations",yh="batchId",Tn="userMutationsIndex",Ih=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ns(r,e){return[r,ke(e)]}function Yf(r,e,t){return[r,ke(e),t]}const QE={},ar="documentMutations",eo="remoteDocumentsV14",XE=["prefixPath","collectionGroup","readTime","documentId"],xs="documentKeyIndex",JE=["prefixPath","collectionGroup","documentId"],Zf="collectionGroupIndex",YE=["collectionGroup","readTime","prefixPath","documentId"],wi="remoteDocumentGlobal",Ga="remoteDocumentGlobalKey",cr="targets",ep="queryTargetsIndex",ZE=["canonicalId","targetId"],ur="targetDocuments",eT=["targetId","path"],xc="documentTargetsIndex",tT=["path","targetId"],to="targetGlobalKey",An="targetGlobal",Ai="collectionParents",nT=["collectionId","parent"],lr="clientMetadata",rT="clientId",Co="bundles",iT="bundleId",Vo="namedQueries",sT="name",Oc="indexConfiguration",oT="indexId",Wa="collectionGroupIndex",aT="collectionGroup",hi="indexState",cT=["indexId","uid"],tp="sequenceNumberIndex",uT=["uid","sequenceNumber"],di="indexEntries",lT=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],np="documentKeyIndex",hT=["indexId","uid","orderedDocumentKey"],Do="documentOverlays",dT=["userId","collectionPath","documentId"],Ha="collectionPathOverlayIndex",fT=["userId","collectionPath","largestBatchId"],rp="collectionGroupOverlayIndex",pT=["userId","collectionGroup","largestBatchId"],Mc="globals",mT="name",ip=[vi,Qe,ar,gn,cr,qi,An,ur,lr,wi,Ai,Co,Vo],gT=[...ip,Do],sp=[vi,Qe,ar,eo,cr,qi,An,ur,lr,wi,Ai,Co,Vo,Do],op=sp,Lc=[...op,Oc,hi,di],_T=Lc,ap=[...Lc,Mc],yT=ap;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qa extends Qf{constructor(e,t){super(),this.ce=e,this.currentSequenceNumber=t}}function Ie(r,e){const t=F(r);return Wt.N(t.ce,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $c(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ti(e)?"-0":e}}function Np(r){return{integerValue:""+r}}function LT(r,e){return Jf(e)?Np(e):$c(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oo{constructor(){this._=void 0}}function FT(r,e,t){return r instanceof mr?(function(i,s){const o={fields:{[hp]:{stringValue:lp},[fp]:{timestampValue:{seconds:i.seconds,nanos:i.nanoseconds}}}};return s&&Fc(s)&&(s=ko(s)),s&&(o.fields[dp]=s),{mapValue:o}})(t,e):r instanceof gr?Op(r,e):r instanceof _r?Mp(r,e):(function(i,s){const o=xp(i,s),c=Nh(o)+Nh(i.Ee);return Ja(o)&&Ja(i.Ee)?Np(c):$c(i.serializer,c)})(r,e)}function UT(r,e,t){return r instanceof gr?Op(r,e):r instanceof _r?Mp(r,e):t}function xp(r,e){return r instanceof Ci?(function(n){return Ja(n)||(function(s){return!!s&&"doubleValue"in s})(n)})(e)?e:{integerValue:0}:null}class mr extends Oo{}class gr extends Oo{constructor(e){super(),this.elements=e}}function Op(r,e){const t=Lp(e);for(const n of r.elements)t.some((i=>at(i,n)))||t.push(n);return{arrayValue:{values:t}}}class _r extends Oo{constructor(e){super(),this.elements=e}}function Mp(r,e){let t=Lp(e);for(const n of r.elements)t=t.filter((i=>!at(i,n)));return{arrayValue:{values:t}}}class Ci extends Oo{constructor(e,t){super(),this.serializer=e,this.Ee=t}}function Nh(r){return ae(r.integerValue||r.doubleValue)}function Lp(r){return Si(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fp{constructor(e,t){this.field=e,this.transform=t}}function BT(r,e){return r.field.isEqual(e.field)&&(function(n,i){return n instanceof gr&&i instanceof gr||n instanceof _r&&i instanceof _r?sr(n.elements,i.elements,at):n instanceof Ci&&i instanceof Ci?at(n.Ee,i.Ee):n instanceof mr&&i instanceof mr})(r.transform,e.transform)}class jT{constructor(e,t){this.version=e,this.transformResults=t}}class ue{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new ue}static exists(e){return new ue(void 0,e)}static updateTime(e){return new ue(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Fs(r,e){return r.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(r.updateTime):r.exists===void 0||r.exists===e.isFoundDocument()}class Mo{}function Up(r,e){if(!r.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return r.isNoDocument()?new br(r.key,ue.none()):new Rr(r.key,r.data,ue.none());{const t=r.data,n=Ae.empty();let i=new re(he.comparator);for(let s of e.fields)if(!i.has(s)){let o=t.field(s);o===null&&s.length>1&&(s=s.popLast(),o=t.field(s)),o===null?n.delete(s):n.set(s,o),i=i.add(s)}return new Pt(r.key,n,new Le(i.toArray()),ue.none())}}function qT(r,e,t){r instanceof Rr?(function(i,s,o){const c=i.value.clone(),u=Oh(i.fieldTransforms,s,o.transformResults);c.setAll(u),s.convertToFoundDocument(o.version,c).setHasCommittedMutations()})(r,e,t):r instanceof Pt?(function(i,s,o){if(!Fs(i.precondition,s))return void s.convertToUnknownDocument(o.version);const c=Oh(i.fieldTransforms,s,o.transformResults),u=s.data;u.setAll(Bp(i)),u.setAll(c),s.convertToFoundDocument(o.version,u).setHasCommittedMutations()})(r,e,t):(function(i,s,o){s.convertToNoDocument(o.version).setHasCommittedMutations()})(0,e,t)}function gi(r,e,t,n){return r instanceof Rr?(function(s,o,c,u){if(!Fs(s.precondition,o))return c;const h=s.value.clone(),f=Mh(s.fieldTransforms,u,o);return h.setAll(f),o.convertToFoundDocument(o.version,h).setHasLocalMutations(),null})(r,e,t,n):r instanceof Pt?(function(s,o,c,u){if(!Fs(s.precondition,o))return c;const h=Mh(s.fieldTransforms,u,o),f=o.data;return f.setAll(Bp(s)),f.setAll(h),o.convertToFoundDocument(o.version,f).setHasLocalMutations(),c===null?null:c.unionWith(s.fieldMask.fields).unionWith(s.fieldTransforms.map((m=>m.field)))})(r,e,t,n):(function(s,o,c){return Fs(s.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):c})(r,e,t)}function $T(r,e){let t=null;for(const n of r.fieldTransforms){const i=e.data.field(n.field),s=xp(n.transform,i||null);s!=null&&(t===null&&(t=Ae.empty()),t.set(n.field,s))}return t||null}function xh(r,e){return r.type===e.type&&!!r.key.isEqual(e.key)&&!!r.precondition.isEqual(e.precondition)&&!!(function(n,i){return n===void 0&&i===void 0||!(!n||!i)&&sr(n,i,((s,o)=>BT(s,o)))})(r.fieldTransforms,e.fieldTransforms)&&(r.type===0?r.value.isEqual(e.value):r.type!==1||r.data.isEqual(e.data)&&r.fieldMask.isEqual(e.fieldMask))}class Rr extends Mo{constructor(e,t,n,i=[]){super(),this.key=e,this.value=t,this.precondition=n,this.fieldTransforms=i,this.type=0}getFieldMask(){return null}}class Pt extends Mo{constructor(e,t,n,i,s=[]){super(),this.key=e,this.data=t,this.fieldMask=n,this.precondition=i,this.fieldTransforms=s,this.type=1}getFieldMask(){return this.fieldMask}}function Bp(r){const e=new Map;return r.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const n=r.data.field(t);e.set(t,n)}})),e}function Oh(r,e,t){const n=new Map;U(r.length===t.length,32656,{Ae:t.length,Re:r.length});for(let i=0;i<t.length;i++){const s=r[i],o=s.transform,c=e.data.field(s.field);n.set(s.field,UT(o,c,t[i]))}return n}function Mh(r,e,t){const n=new Map;for(const i of r){const s=i.transform,o=t.data.field(i.field);n.set(i.field,FT(s,o,e))}return n}class br extends Mo{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class zc extends Mo{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lo{constructor(e,t){this.serializer=e,this.userId=t}static yt(e,t){const n=t.uid||"";return new Lo(e,n)}getOverlay(e,t){return Xr(e).get($h(this.userId,t)).next((n=>n?ba(this.serializer,n):null))}getOverlays(e,t){const n=nt();return w.forEach(t,(i=>this.getOverlay(e,i).next((s=>{s!==null&&n.set(i,s)})))).next((()=>n))}saveOverlays(e,t,n){const i=[];return n.forEach(((s,o)=>{const c=new Wc(t,o);i.push(this.wt(e,c))})),w.waitFor(i)}removeOverlaysForBatchId(e,t,n){const i=new Set;t.forEach((o=>i.add(ke(o.getCollectionPath()))));const s=[];return i.forEach((o=>{const c=IDBKeyRange.bound([this.userId,o,n],[this.userId,o,n+1],!1,!0);s.push(Xr(e).Y(Ha,c))})),w.waitFor(s)}getOverlaysForCollection(e,t,n){const i=nt(),s=ke(t),o=IDBKeyRange.bound([this.userId,s,n],[this.userId,s,Number.POSITIVE_INFINITY],!0);return Xr(e).j(Ha,o).next((c=>{for(const u of c){const h=ba(this.serializer,u);i.set(h.getKey(),h)}return i}))}getOverlaysForCollectionGroup(e,t,n,i){const s=nt();let o;const c=IDBKeyRange.bound([this.userId,t,n],[this.userId,t,Number.POSITIVE_INFINITY],!0);return Xr(e).X({index:rp,range:c},((u,h,f)=>{const m=ba(this.serializer,h);s.size()<i||m.largestBatchId===o?(s.set(m.getKey(),m),o=m.largestBatchId):f.done()})).next((()=>s))}wt(e,t){return Xr(e).put((function(i,s,o){const[c,u,h]=$h(s,o.mutation.key);return{userId:s,collectionPath:u,documentId:h,collectionGroup:o.mutation.key.getCollectionGroup(),largestBatchId:o.largestBatchId,overlayMutation:Di(i.gt,o.mutation)}})(this.serializer,this.userId,t))}}function Xr(r){return Ie(r,Do)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uv{St(e){return Ie(e,Mc)}getSessionToken(e){return this.St(e).get("sessionToken").next((t=>{const n=t==null?void 0:t.value;return n?pe.fromUint8Array(n):pe.EMPTY_BYTE_STRING}))}setSessionToken(e,t){return this.St(e).put({name:"sessionToken",value:t.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gn=255;function lv(r){if(r===0)return 8;let e=0;return r>>4||(e+=4,r<<=4),r>>6||(e+=2,r<<=2),r>>7||(e+=1),e}function Wh(r){const e=64-(function(n){let i=0;for(let s=0;s<8;++s){const o=lv(255&n[s]);if(i+=o,o!==8)break}return i})(r);return Math.ceil(e/8)}class hv{constructor(){this.buffer=new Uint8Array(1024),this.position=0}Kt(e){const t=e[Symbol.iterator]();let n=t.next();for(;!n.done;)this.Wt(n.value),n=t.next();this.Gt()}zt(e){const t=e[Symbol.iterator]();let n=t.next();for(;!n.done;)this.jt(n.value),n=t.next();this.Jt()}Ht(e){for(const t of e){const n=t.charCodeAt(0);if(n<128)this.Wt(n);else if(n<2048)this.Wt(960|n>>>6),this.Wt(128|63&n);else if(t<"\uD800"||"\uDBFF"<t)this.Wt(480|n>>>12),this.Wt(128|63&n>>>6),this.Wt(128|63&n);else{const i=t.codePointAt(0);this.Wt(240|i>>>18),this.Wt(128|63&i>>>12),this.Wt(128|63&i>>>6),this.Wt(128|63&i)}}this.Gt()}Yt(e){for(const t of e){const n=t.charCodeAt(0);if(n<128)this.jt(n);else if(n<2048)this.jt(960|n>>>6),this.jt(128|63&n);else if(t<"\uD800"||"\uDBFF"<t)this.jt(480|n>>>12),this.jt(128|63&n>>>6),this.jt(128|63&n);else{const i=t.codePointAt(0);this.jt(240|i>>>18),this.jt(128|63&i>>>12),this.jt(128|63&i>>>6),this.jt(128|63&i)}}this.Jt()}Zt(e){const t=this.Xt(e),n=Wh(t);this.en(1+n),this.buffer[this.position++]=255&n;for(let i=t.length-n;i<t.length;++i)this.buffer[this.position++]=255&t[i]}tn(e){const t=this.Xt(e),n=Wh(t);this.en(1+n),this.buffer[this.position++]=~(255&n);for(let i=t.length-n;i<t.length;++i)this.buffer[this.position++]=~(255&t[i])}nn(){this.rn(Gn),this.rn(255)}sn(){this._n(Gn),this._n(255)}reset(){this.position=0}seed(e){this.en(e.length),this.buffer.set(e,this.position),this.position+=e.length}an(){return this.buffer.slice(0,this.position)}Xt(e){const t=(function(s){const o=new DataView(new ArrayBuffer(8));return o.setFloat64(0,s,!1),new Uint8Array(o.buffer)})(e),n=!!(128&t[0]);t[0]^=n?255:128;for(let i=1;i<t.length;++i)t[i]^=n?255:0;return t}Wt(e){const t=255&e;t===0?(this.rn(0),this.rn(255)):t===Gn?(this.rn(Gn),this.rn(0)):this.rn(t)}jt(e){const t=255&e;t===0?(this._n(0),this._n(255)):t===Gn?(this._n(Gn),this._n(0)):this._n(e)}Gt(){this.rn(0),this.rn(1)}Jt(){this._n(0),this._n(1)}rn(e){this.en(1),this.buffer[this.position++]=e}_n(e){this.en(1),this.buffer[this.position++]=~e}en(e){const t=e+this.position;if(t<=this.buffer.length)return;let n=2*this.buffer.length;n<t&&(n=t);const i=new Uint8Array(n);i.set(this.buffer),this.buffer=i}}class dv{constructor(e){this.un=e}Nt(e){this.un.Kt(e)}Mt(e){this.un.Ht(e)}Ft(e){this.un.Zt(e)}vt(){this.un.nn()}}class fv{constructor(e){this.un=e}Nt(e){this.un.zt(e)}Mt(e){this.un.Yt(e)}Ft(e){this.un.tn(e)}vt(){this.un.sn()}}class Jr{constructor(){this.un=new hv,this.cn=new dv(this.un),this.ln=new fv(this.un)}seed(e){this.un.seed(e)}hn(e){return e===0?this.cn:this.ln}an(){return this.un.an()}reset(){this.un.reset()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sm(r){var e,t;if(U(r instanceof Q||r instanceof ne,20012),r instanceof Q){if(r instanceof Ap){const i=((t=(e=r.value.arrayValue)===null||e===void 0?void 0:e.values)===null||t===void 0?void 0:t.map((s=>Q.create(r.field,"==",s))))||[];return ne.create(i,"or")}return r}const n=r.filters.map((i=>sm(i)));return ne.create(n,r.op)}function pv(r){if(r.getFilters().length===0)return[];const e=uc(sm(r));return U(om(e),7391),ac(e)||cc(e)?[e]:e.getFilters()}function ac(r){return r instanceof Q}function cc(r){return r instanceof ne&&jc(r)}function om(r){return ac(r)||cc(r)||(function(t){if(t instanceof ne&&Ya(t)){for(const n of t.getFilters())if(!ac(n)&&!cc(n))return!1;return!0}return!1})(r)}function uc(r){if(U(r instanceof Q||r instanceof ne,34018),r instanceof Q)return r;if(r.filters.length===1)return uc(r.filters[0]);const e=r.filters.map((n=>uc(n)));let t=ne.create(e,r.op);return t=ao(t),om(t)?t:(U(t instanceof ne,64498),U(pr(t),40251),U(t.filters.length>1,57927),t.filters.reduce(((n,i)=>Xc(n,i))))}function Xc(r,e){let t;return U(r instanceof Q||r instanceof ne,38388),U(e instanceof Q||e instanceof ne,25473),t=r instanceof Q?e instanceof Q?(function(i,s){return ne.create([i,s],"and")})(r,e):Jh(r,e):e instanceof Q?Jh(e,r):(function(i,s){if(U(i.filters.length>0&&s.filters.length>0,48005),pr(i)&&pr(s))return Tp(i,s.getFilters());const o=Ya(i)?i:s,c=Ya(i)?s:i,u=o.filters.map((h=>Xc(h,c)));return ne.create(u,"or")})(r,e),ao(t)}function Jh(r,e){if(pr(e))return Tp(e,r.getFilters());{const t=e.filters.map((n=>Xc(r,n)));return ne.create(t,"or")}}function ao(r){if(U(r instanceof Q||r instanceof ne,11850),r instanceof Q)return r;const e=r.getFilters();if(e.length===1)return ao(e[0]);if(Ip(r))return r;const t=e.map((i=>ao(i))),n=[];return t.forEach((i=>{i instanceof Q?n.push(i):i instanceof ne&&(i.op===r.op?n.push(...i.filters):n.push(i))})),n.length===1?n[0]:ne.create(n,r.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cm(r,e,t){const n=r.store(Qe),i=r.store(ar),s=[],o=IDBKeyRange.only(t.batchId);let c=0;const u=n.X({range:o},((f,m,g)=>(c++,g.delete())));s.push(u.next((()=>{U(c===1,47070,{batchId:t.batchId})})));const h=[];for(const f of t.mutations){const m=Yf(e,f.key.path,t.batchId);s.push(i.delete(m)),h.push(f.key)}return w.waitFor(s).next((()=>h))}function co(r){if(!r)return 0;let e;if(r.document)e=r.document;else if(r.unknownDocument)e=r.unknownDocument;else{if(!r.noDocument)throw M(14731);e=r.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _v{constructor(e,t){this.referenceDelegate=e,this.serializer=t}allocateTargetId(e){return this.cr(e).next((t=>{const n=new On(t.highestTargetId);return t.highestTargetId=n.next(),this.lr(e,t).next((()=>t.highestTargetId))}))}getLastRemoteSnapshotVersion(e){return this.cr(e).next((t=>B.fromTimestamp(new te(t.lastRemoteSnapshotVersion.seconds,t.lastRemoteSnapshotVersion.nanoseconds))))}getHighestSequenceNumber(e){return this.cr(e).next((t=>t.highestListenSequenceNumber))}setTargetsMetadata(e,t,n){return this.cr(e).next((i=>(i.highestListenSequenceNumber=t,n&&(i.lastRemoteSnapshotVersion=n.toTimestamp()),t>i.highestListenSequenceNumber&&(i.highestListenSequenceNumber=t),this.lr(e,i))))}addTargetData(e,t){return this.hr(e,t).next((()=>this.cr(e).next((n=>(n.targetCount+=1,this.Pr(t,n),this.lr(e,n))))))}updateTargetData(e,t){return this.hr(e,t)}removeTargetData(e,t){return this.removeMatchingKeysForTargetId(e,t.targetId).next((()=>Qn(e).delete(t.targetId))).next((()=>this.cr(e))).next((n=>(U(n.targetCount>0,8065),n.targetCount-=1,this.lr(e,n))))}removeTargets(e,t,n){let i=0;const s=[];return Qn(e).X(((o,c)=>{const u=oi(c);u.sequenceNumber<=t&&n.get(u.targetId)===null&&(i++,s.push(this.removeTargetData(e,u)))})).next((()=>w.waitFor(s))).next((()=>i))}forEachTarget(e,t){return Qn(e).X(((n,i)=>{const s=oi(i);t(s)}))}cr(e){return nd(e).get(to).next((t=>(U(t!==null,2888),t)))}lr(e,t){return nd(e).put(to,t)}hr(e,t){return Qn(e).put(rm(this.serializer,t))}Pr(e,t){let n=!1;return e.targetId>t.highestTargetId&&(t.highestTargetId=e.targetId,n=!0),e.sequenceNumber>t.highestListenSequenceNumber&&(t.highestListenSequenceNumber=e.sequenceNumber,n=!0),n}getTargetCount(e){return this.cr(e).next((t=>t.targetCount))}getTargetData(e,t){const n=kn(t),i=IDBKeyRange.bound([n,Number.NEGATIVE_INFINITY],[n,Number.POSITIVE_INFINITY]);let s=null;return Qn(e).X({range:i,index:ep},((o,c,u)=>{const h=oi(c);$i(t,h.target)&&(s=h,u.done())})).next((()=>s))}addMatchingKeys(e,t,n){const i=[],s=Bt(e);return t.forEach((o=>{const c=ke(o.path);i.push(s.put({targetId:n,path:c})),i.push(this.referenceDelegate.addReference(e,n,o))})),w.waitFor(i)}removeMatchingKeys(e,t,n){const i=Bt(e);return w.forEach(t,(s=>{const o=ke(s.path);return w.waitFor([i.delete([n,o]),this.referenceDelegate.removeReference(e,n,s)])}))}removeMatchingKeysForTargetId(e,t){const n=Bt(e),i=IDBKeyRange.bound([t],[t+1],!1,!0);return n.delete(i)}getMatchingKeysForTargetId(e,t){const n=IDBKeyRange.bound([t],[t+1],!1,!0),i=Bt(e);let s=W();return i.X({range:n,Z:!0},((o,c,u)=>{const h=tt(o[1]),f=new O(h);s=s.add(f)})).next((()=>s))}containsKey(e,t){const n=ke(t.path),i=IDBKeyRange.bound([n],[$f(n)],!1,!0);let s=0;return Bt(e).X({index:xc,Z:!0,range:i},(([o,c],u,h)=>{o!==0&&(s++,h.done())})).next((()=>s>0))}Et(e,t){return Qn(e).get(t).next((n=>n?oi(n):null))}}function Qn(r){return Ie(r,cr)}function nd(r){return Ie(r,An)}function Bt(r){return Ie(r,ur)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kv{constructor(e){this.serializer=e}q(e,t,n,i){const s=new So("createOrUpgrade",t);n<1&&i>=1&&((function(u){u.createObjectStore(qi)})(e),(function(u){u.createObjectStore(vi,{keyPath:HE}),u.createObjectStore(Qe,{keyPath:yh,autoIncrement:!0}).createIndex(Tn,Ih,{unique:!0}),u.createObjectStore(ar)})(e),cd(e),(function(u){u.createObjectStore(gn)})(e));let o=w.resolve();return n<3&&i>=3&&(n!==0&&((function(u){u.deleteObjectStore(ur),u.deleteObjectStore(cr),u.deleteObjectStore(An)})(e),cd(e)),o=o.next((()=>(function(u){const h=u.store(An),f={highestTargetId:0,highestListenSequenceNumber:0,lastRemoteSnapshotVersion:B.min().toTimestamp(),targetCount:0};return h.put(to,f)})(s)))),n<4&&i>=4&&(n!==0&&(o=o.next((()=>(function(u,h){return h.store(Qe).j().next((m=>{u.deleteObjectStore(Qe),u.createObjectStore(Qe,{keyPath:yh,autoIncrement:!0}).createIndex(Tn,Ih,{unique:!0});const g=h.store(Qe),b=m.map((C=>g.put(C)));return w.waitFor(b)}))})(e,s)))),o=o.next((()=>{(function(u){u.createObjectStore(lr,{keyPath:rT})})(e)}))),n<5&&i>=5&&(o=o.next((()=>this.pi(s)))),n<6&&i>=6&&(o=o.next((()=>((function(u){u.createObjectStore(wi)})(e),this.yi(s))))),n<7&&i>=7&&(o=o.next((()=>this.wi(s)))),n<8&&i>=8&&(o=o.next((()=>this.Si(e,s)))),n<9&&i>=9&&(o=o.next((()=>{(function(u){u.objectStoreNames.contains("remoteDocumentChanges")&&u.deleteObjectStore("remoteDocumentChanges")})(e)}))),n<10&&i>=10&&(o=o.next((()=>this.bi(s)))),n<11&&i>=11&&(o=o.next((()=>{(function(u){u.createObjectStore(Co,{keyPath:iT})})(e),(function(u){u.createObjectStore(Vo,{keyPath:sT})})(e)}))),n<12&&i>=12&&(o=o.next((()=>{(function(u){const h=u.createObjectStore(Do,{keyPath:dT});h.createIndex(Ha,fT,{unique:!1}),h.createIndex(rp,pT,{unique:!1})})(e)}))),n<13&&i>=13&&(o=o.next((()=>(function(u){const h=u.createObjectStore(eo,{keyPath:XE});h.createIndex(xs,JE),h.createIndex(Zf,YE)})(e))).next((()=>this.Di(e,s))).next((()=>e.deleteObjectStore(gn)))),n<14&&i>=14&&(o=o.next((()=>this.Ci(e,s)))),n<15&&i>=15&&(o=o.next((()=>(function(u){u.createObjectStore(Oc,{keyPath:oT,autoIncrement:!0}).createIndex(Wa,aT,{unique:!1}),u.createObjectStore(hi,{keyPath:cT}).createIndex(tp,uT,{unique:!1}),u.createObjectStore(di,{keyPath:lT}).createIndex(np,hT,{unique:!1})})(e)))),n<16&&i>=16&&(o=o.next((()=>{t.objectStore(hi).clear()})).next((()=>{t.objectStore(di).clear()}))),n<17&&i>=17&&(o=o.next((()=>{(function(u){u.createObjectStore(Mc,{keyPath:mT})})(e)}))),n<18&&i>=18&&Kd()&&(o=o.next((()=>{t.objectStore(hi).clear()})).next((()=>{t.objectStore(di).clear()}))),o}yi(e){let t=0;return e.store(gn).X(((n,i)=>{t+=co(i)})).next((()=>{const n={byteSize:t};return e.store(wi).put(Ga,n)}))}pi(e){const t=e.store(vi),n=e.store(Qe);return t.j().next((i=>w.forEach(i,(s=>{const o=IDBKeyRange.bound([s.userId,wn],[s.userId,s.lastAcknowledgedBatchId]);return n.j(Tn,o).next((c=>w.forEach(c,(u=>{U(u.userId===s.userId,18650,"Cannot process batch from unexpected user",{batchId:u.batchId});const h=yn(this.serializer,u);return cm(e,s.userId,h).next((()=>{}))}))))}))))}wi(e){const t=e.store(ur),n=e.store(gn);return e.store(An).get(to).next((i=>{const s=[];return n.X(((o,c)=>{const u=new Y(o),h=(function(m){return[0,ke(m)]})(u);s.push(t.get(h).next((f=>f?w.resolve():(m=>t.put({targetId:0,path:ke(m),sequenceNumber:i.highestListenSequenceNumber}))(u))))})).next((()=>w.waitFor(s)))}))}Si(e,t){e.createObjectStore(Ai,{keyPath:nT});const n=t.store(Ai),i=new Jc,s=o=>{if(i.add(o)){const c=o.lastSegment(),u=o.popLast();return n.put({collectionId:c,parent:ke(u)})}};return t.store(gn).X({Z:!0},((o,c)=>{const u=new Y(o);return s(u.popLast())})).next((()=>t.store(ar).X({Z:!0},(([o,c,u],h)=>{const f=tt(c);return s(f.popLast())}))))}bi(e){const t=e.store(cr);return t.X(((n,i)=>{const s=oi(i),o=rm(this.serializer,s);return t.put(o)}))}Di(e,t){const n=t.store(gn),i=[];return n.X(((s,o)=>{const c=t.store(eo),u=(function(m){return m.document?new O(Y.fromString(m.document.name).popFirst(5)):m.noDocument?O.fromSegments(m.noDocument.path):m.unknownDocument?O.fromSegments(m.unknownDocument.path):M(36783)})(o).path.toArray(),h={prefixPath:u.slice(0,u.length-2),collectionGroup:u[u.length-2],documentId:u[u.length-1],readTime:o.readTime||[0,0],unknownDocument:o.unknownDocument,noDocument:o.noDocument,document:o.document,hasCommittedMutations:!!o.hasCommittedMutations};i.push(c.put(h))})).next((()=>w.waitFor(i)))}Ci(e,t){const n=t.store(Qe),i=mm(this.serializer),s=new Zc(Uo.Vi,this.serializer.gt);return n.j().next((o=>{const c=new Map;return o.forEach((u=>{var h;let f=(h=c.get(u.userId))!==null&&h!==void 0?h:W();yn(this.serializer,u).keys().forEach((m=>f=f.add(m))),c.set(u.userId,f)})),w.forEach(c,((u,h)=>{const f=new Ve(h),m=Lo.yt(this.serializer,f),g=s.getIndexManager(f),b=Fo.yt(f,this.serializer,g,s.referenceDelegate);return new gm(i,b,m,g).recalculateAndSaveOverlaysForDocumentKeys(new Qa(t,Me.ue),u).next()}))}))}}function cd(r){r.createObjectStore(ur,{keyPath:eT}).createIndex(xc,tT,{unique:!0}),r.createObjectStore(cr,{keyPath:"targetId"}).createIndex(ep,ZE,{unique:!0}),r.createObjectStore(An)}const Ot="IndexedDbPersistence",Pa=18e5,Sa=5e3,Ca="Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.",Nv="main";class eu{constructor(e,t,n,i,s,o,c,u,h,f,m=18){if(this.allowTabSynchronization=e,this.persistenceKey=t,this.clientId=n,this.Fi=s,this.window=o,this.document=c,this.Mi=h,this.xi=f,this.Oi=m,this.ui=null,this.ci=!1,this.isPrimary=!1,this.networkEnabled=!0,this.Ni=null,this.inForeground=!1,this.Bi=null,this.Li=null,this.ki=Number.NEGATIVE_INFINITY,this.qi=g=>Promise.resolve(),!eu.C())throw new N(S.UNIMPLEMENTED,"This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");this.referenceDelegate=new Ev(this,i),this.Qi=t+Nv,this.serializer=new nm(u),this.$i=new Wt(this.Qi,this.Oi,new kv(this.serializer)),this.li=new uv,this.hi=new _v(this.referenceDelegate,this.serializer),this.remoteDocumentCache=mm(this.serializer),this.Ti=new cv,this.window&&this.window.localStorage?this.Ui=this.window.localStorage:(this.Ui=null,f===!1&&fe(Ot,"LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."))}start(){return this.Ki().then((()=>{if(!this.isPrimary&&!this.allowTabSynchronization)throw new N(S.FAILED_PRECONDITION,Ca);return this.Wi(),this.Gi(),this.zi(),this.runTransaction("getHighestListenSequenceNumber","readonly",(e=>this.hi.getHighestSequenceNumber(e)))})).then((e=>{this.ui=new Me(e,this.Mi)})).then((()=>{this.ci=!0})).catch((e=>(this.$i&&this.$i.close(),Promise.reject(e))))}ji(e){return this.qi=async t=>{if(this.started)return e(t)},e(this.isPrimary)}setDatabaseDeletedListener(e){this.$i.setDatabaseDeletedListener(e)}setNetworkEnabled(e){this.networkEnabled!==e&&(this.networkEnabled=e,this.Fi.enqueueAndForget((async()=>{this.started&&await this.Ki()})))}Ki(){return this.runTransaction("updateClientMetadataAndTryBecomePrimary","readwrite",(e=>As(e).put({clientId:this.clientId,updateTimeMs:Date.now(),networkEnabled:this.networkEnabled,inForeground:this.inForeground}).next((()=>{if(this.isPrimary)return this.Ji(e).next((t=>{t||(this.isPrimary=!1,this.Fi.enqueueRetryable((()=>this.qi(!1))))}))})).next((()=>this.Hi(e))).next((t=>this.isPrimary&&!t?this.Yi(e).next((()=>!1)):!!t&&this.Zi(e).next((()=>!0)))))).catch((e=>{if(rn(e))return D(Ot,"Failed to extend owner lease: ",e),this.isPrimary;if(!this.allowTabSynchronization)throw e;return D(Ot,"Releasing owner lease after error during lease refresh",e),!1})).then((e=>{this.isPrimary!==e&&this.Fi.enqueueRetryable((()=>this.qi(e))),this.isPrimary=e}))}Ji(e){return ei(e).get(zn).next((t=>w.resolve(this.Xi(t))))}es(e){return As(e).delete(this.clientId)}async ts(){if(this.isPrimary&&!this.ns(this.ki,Pa)){this.ki=Date.now();const e=await this.runTransaction("maybeGarbageCollectMultiClientState","readwrite-primary",(t=>{const n=Ie(t,lr);return n.j().next((i=>{const s=this.rs(i,Pa),o=i.filter((c=>s.indexOf(c)===-1));return w.forEach(o,(c=>n.delete(c.clientId))).next((()=>o))}))})).catch((()=>[]));if(this.Ui)for(const t of e)this.Ui.removeItem(this.ss(t.clientId))}}zi(){this.Li=this.Fi.enqueueAfterDelay("client_metadata_refresh",4e3,(()=>this.Ki().then((()=>this.ts())).then((()=>this.zi()))))}Xi(e){return!!e&&e.ownerId===this.clientId}Hi(e){return this.xi?w.resolve(!0):ei(e).get(zn).next((t=>{if(t!==null&&this.ns(t.leaseTimestampMs,Sa)&&!this._s(t.ownerId)){if(this.Xi(t)&&this.networkEnabled)return!0;if(!this.Xi(t)){if(!t.allowTabSynchronization)throw new N(S.FAILED_PRECONDITION,Ca);return!1}}return!(!this.networkEnabled||!this.inForeground)||As(e).j().next((n=>this.rs(n,Sa).find((i=>{if(this.clientId!==i.clientId){const s=!this.networkEnabled&&i.networkEnabled,o=!this.inForeground&&i.inForeground,c=this.networkEnabled===i.networkEnabled;if(s||o&&c)return!0}return!1}))===void 0))})).next((t=>(this.isPrimary!==t&&D(Ot,`Client ${t?"is":"is not"} eligible for a primary lease.`),t)))}async shutdown(){this.ci=!1,this.us(),this.Li&&(this.Li.cancel(),this.Li=null),this.cs(),this.ls(),await this.$i.runTransaction("shutdown","readwrite",[qi,lr],(e=>{const t=new Qa(e,Me.ue);return this.Yi(t).next((()=>this.es(t)))})),this.$i.close(),this.hs()}rs(e,t){return e.filter((n=>this.ns(n.updateTimeMs,t)&&!this._s(n.clientId)))}Ps(){return this.runTransaction("getActiveClients","readonly",(e=>As(e).j().next((t=>this.rs(t,Pa).map((n=>n.clientId))))))}get started(){return this.ci}getGlobalsCache(){return this.li}getMutationQueue(e,t){return Fo.yt(e,this.serializer,t,this.referenceDelegate)}getTargetCache(){return this.hi}getRemoteDocumentCache(){return this.remoteDocumentCache}getIndexManager(e){return new gv(e,this.serializer.gt.databaseId)}getDocumentOverlayCache(e){return Lo.yt(this.serializer,e)}getBundleCache(){return this.Ti}runTransaction(e,t,n){D(Ot,"Starting transaction:",e);const i=t==="readonly"?"readonly":"readwrite",s=(function(u){return u===18?yT:u===17?ap:u===16?_T:u===15?Lc:u===14?op:u===13?sp:u===12?gT:u===11?ip:void M(60245)})(this.Oi);let o;return this.$i.runTransaction(e,i,s,(c=>(o=new Qa(c,this.ui?this.ui.next():Me.ue),t==="readwrite-primary"?this.Ji(o).next((u=>!!u||this.Hi(o))).next((u=>{if(!u)throw fe(`Failed to obtain primary lease for action '${e}'.`),this.isPrimary=!1,this.Fi.enqueueRetryable((()=>this.qi(!1))),new N(S.FAILED_PRECONDITION,Hf);return n(o)})).next((u=>this.Zi(o).next((()=>u)))):this.Ts(o).next((()=>n(o)))))).then((c=>(o.raiseOnCommittedEvent(),c)))}Ts(e){return ei(e).get(zn).next((t=>{if(t!==null&&this.ns(t.leaseTimestampMs,Sa)&&!this._s(t.ownerId)&&!this.Xi(t)&&!(this.xi||this.allowTabSynchronization&&t.allowTabSynchronization))throw new N(S.FAILED_PRECONDITION,Ca)}))}Zi(e){const t={ownerId:this.clientId,allowTabSynchronization:this.allowTabSynchronization,leaseTimestampMs:Date.now()};return ei(e).put(zn,t)}static C(){return Wt.C()}Yi(e){const t=ei(e);return t.get(zn).next((n=>this.Xi(n)?(D(Ot,"Releasing primary lease."),t.delete(zn)):w.resolve()))}ns(e,t){const n=Date.now();return!(e<n-t)&&(!(e>n)||(fe(`Detected an update time that is in the future: ${e} > ${n}`),!1))}Wi(){this.document!==null&&typeof this.document.addEventListener=="function"&&(this.Bi=()=>{this.Fi.enqueueAndForget((()=>(this.inForeground=this.document.visibilityState==="visible",this.Ki())))},this.document.addEventListener("visibilitychange",this.Bi),this.inForeground=this.document.visibilityState==="visible")}cs(){this.Bi&&(this.document.removeEventListener("visibilitychange",this.Bi),this.Bi=null)}Gi(){var e;typeof((e=this.window)===null||e===void 0?void 0:e.addEventListener)=="function"&&(this.Ni=()=>{this.us();const t=/(?:Version|Mobile)\/1[456]/;zd()&&(navigator.appVersion.match(t)||navigator.userAgent.match(t))&&this.Fi.enterRestrictedMode(!0),this.Fi.enqueueAndForget((()=>this.shutdown()))},this.window.addEventListener("pagehide",this.Ni))}ls(){this.Ni&&(this.window.removeEventListener("pagehide",this.Ni),this.Ni=null)}_s(e){var t;try{const n=((t=this.Ui)===null||t===void 0?void 0:t.getItem(this.ss(e)))!==null;return D(Ot,`Client '${e}' ${n?"is":"is not"} zombied in LocalStorage`),n}catch(n){return fe(Ot,"Failed to get zombied client id.",n),!1}}us(){if(this.Ui)try{this.Ui.setItem(this.ss(this.clientId),String(Date.now()))}catch(e){fe("Failed to set zombie client id.",e)}}hs(){if(this.Ui)try{this.Ui.removeItem(this.ss(this.clientId))}catch{}}ss(e){return`firestore_zombie_${this.persistenceKey}_${e}`}}function ei(r){return Ie(r,qi)}function As(r){return Ie(r,lr)}function _m(r,e){let t=r.projectId;return r.isDefaultDatabase||(t+="."+r.database),"firestore/"+e+"/"+t+"/"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tu{constructor(e,t,n,i){this.targetId=e,this.fromCache=t,this.Is=n,this.ds=i}static Es(e,t){let n=W(),i=W();for(const s of t.docChanges)switch(s.type){case 0:n=n.add(s.doc.key);break;case 1:i=i.add(s.doc.key)}return new tu(e,t.fromCache,n,i)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ym{constructor(){this.As=!1,this.Rs=!1,this.Vs=100,this.fs=(function(){return zd()?8:Xf(ye())>0?6:4})()}initialize(e,t){this.gs=e,this.indexManager=t,this.As=!0}getDocumentsMatchingQuery(e,t,n,i){const s={result:null};return this.ps(e,t).next((o=>{s.result=o})).next((()=>{if(!s.result)return this.ys(e,t,i,n).next((o=>{s.result=o}))})).next((()=>{if(s.result)return;const o=new xv;return this.ws(e,t,o).next((c=>{if(s.result=c,this.Rs)return this.Ss(e,t,o,c.size)}))})).next((()=>s.result))}Ss(e,t,n,i){return n.documentReadCount<this.Vs?(Xn()<=H.DEBUG&&D("QueryEngine","SDK will not create cache indexes for query:",Jn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),w.resolve()):(Xn()<=H.DEBUG&&D("QueryEngine","Query:",Jn(t),"scans",n.documentReadCount,"local documents and returns",i,"documents as results."),n.documentReadCount>this.fs*i?(Xn()<=H.DEBUG&&D("QueryEngine","The SDK decides to create cache indexes for query:",Jn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,$e(t))):w.resolve())}ps(e,t){if(kh(t))return w.resolve(null);let n=$e(t);return this.indexManager.getIndexType(e,n).next((i=>i===0?null:(t.limit!==null&&i===1&&(t=nc(t,null,"F"),n=$e(t)),this.indexManager.getDocumentsMatchingTarget(e,n).next((s=>{const o=W(...s);return this.gs.getDocuments(e,o).next((c=>this.indexManager.getMinOffset(e,n).next((u=>{const h=this.bs(t,c);return this.Ds(t,h,o,u.readTime)?this.ps(e,nc(t,null,"F")):this.vs(e,h,t,u)}))))})))))}ys(e,t,n,i){return kh(t)||i.isEqual(B.min())?w.resolve(null):this.gs.getDocuments(e,n).next((s=>{const o=this.bs(t,s);return this.Ds(t,o,n,i)?w.resolve(null):(Xn()<=H.DEBUG&&D("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),Jn(t)),this.vs(e,o,t,Gf(i,or)).next((c=>c)))}))}bs(e,t){let n=new re(Cp(e));return t.forEach(((i,s)=>{Gi(e,s)&&(n=n.add(s))})),n}Ds(e,t,n,i){if(e.limit===null)return!1;if(n.size!==t.size)return!0;const s=e.limitType==="F"?t.last():t.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}ws(e,t,n){return Xn()<=H.DEBUG&&D("QueryEngine","Using full collection scan to execute query:",Jn(t)),this.gs.getDocumentsMatchingQuery(e,t,ze.min(),n)}vs(e,t,n,i){return this.gs.getDocumentsMatchingQuery(e,n,i).next((s=>(t.forEach((o=>{s=s.insert(o.key,o)})),s)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Rs=null;function hc(){return Rs===null?Rs=(function(){return 268435456+Math.round(2147483648*Math.random())})():Rs++,"0x"+Rs.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ka="RestConnection",qv={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class $v{get Qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.$o=t+"://"+e.host,this.Uo=`projects/${n}/databases/${i}`,this.Ko=this.databaseId.database===no?`project_id=${n}`:`project_id=${n}&database_id=${i}`}Wo(e,t,n,i,s){const o=hc(),c=this.Go(e,t.toUriEncodedString());D(ka,`Sending RPC '${e}' ${o}:`,c,n);const u={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.Ko};this.zo(u,i,s);const{host:h}=new URL(c),f=Ln(h);return this.jo(e,c,u,n,f).then((m=>(D(ka,`Received RPC '${e}' ${o}: `,m),m)),(m=>{throw Jt(ka,`RPC '${e}' ${o} failed with error: `,m,"url: ",c,"request:",n),m}))}Jo(e,t,n,i,s,o){return this.Wo(e,t,n,i,s)}zo(e,t,n){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+Ar})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((i,s)=>e[s]=i)),n&&n.headers.forEach(((i,s)=>e[s]=i))}Go(e,t){const n=qv[e];return`${this.$o}/v1/${t}:${n}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fd="PersistentStream";class Vm{constructor(e,t,n,i,s,o,c,u){this.Fi=e,this.w_=n,this.S_=i,this.connection=s,this.authCredentialsProvider=o,this.appCheckCredentialsProvider=c,this.listener=u,this.state=0,this.b_=0,this.D_=null,this.v_=null,this.stream=null,this.C_=0,this.F_=new iu(e,t)}M_(){return this.state===1||this.state===5||this.x_()}x_(){return this.state===2||this.state===3}start(){this.C_=0,this.state!==4?this.auth():this.O_()}async stop(){this.M_()&&await this.close(0)}N_(){this.state=0,this.F_.reset()}B_(){this.x_()&&this.D_===null&&(this.D_=this.Fi.enqueueAfterDelay(this.w_,6e4,(()=>this.L_())))}k_(e){this.q_(),this.stream.send(e)}async L_(){if(this.x_())return this.close(0)}q_(){this.D_&&(this.D_.cancel(),this.D_=null)}Q_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(e,t){this.q_(),this.Q_(),this.F_.cancel(),this.b_++,e!==4?this.F_.reset():t&&t.code===S.RESOURCE_EXHAUSTED?(fe(t.toString()),fe("Using maximum backoff delay to prevent overloading the backend."),this.F_.f_()):t&&t.code===S.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.U_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.n_(t)}U_(){}auth(){this.state=1;const e=this.K_(this.b_),t=this.b_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([n,i])=>{this.b_===t&&this.W_(n,i)}),(n=>{e((()=>{const i=new N(S.UNKNOWN,"Fetching auth token failed: "+n.message);return this.G_(i)}))}))}W_(e,t){const n=this.K_(this.b_);this.stream=this.z_(e,t),this.stream.Zo((()=>{n((()=>this.listener.Zo()))})),this.stream.e_((()=>{n((()=>(this.state=2,this.v_=this.Fi.enqueueAfterDelay(this.S_,1e4,(()=>(this.x_()&&(this.state=3),Promise.resolve()))),this.listener.e_())))})),this.stream.n_((i=>{n((()=>this.G_(i)))})),this.stream.onMessage((i=>{n((()=>++this.C_==1?this.j_(i):this.onNext(i)))}))}O_(){this.state=5,this.F_.g_((async()=>{this.state=0,this.start()}))}G_(e){return D(fd,`close with error: ${e}`),this.stream=null,this.close(4,e)}K_(e){return t=>{this.Fi.enqueueAndForget((()=>this.b_===e?t():(D(fd,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class Gv extends Vm{constructor(e,t,n,i,s,o){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,n,i,o),this.serializer=s}z_(e,t){return this.connection.P_("Listen",e,t)}j_(e){return this.onNext(e)}onNext(e){this.F_.reset();const t=ev(this.serializer,e),n=(function(s){if(!("targetChange"in s))return B.min();const o=s.targetChange;return o.targetIds&&o.targetIds.length?B.min():o.readTime?Te(o.readTime):B.min()})(e);return this.listener.J_(t,n)}H_(e){const t={};t.database=sc(this.serializer),t.addTarget=(function(s,o){let c;const u=o.target;if(c=io(u)?{documents:Xp(s,u)}:{query:Jp(s,u).Vt},c.targetId=o.targetId,o.resumeToken.approximateByteSize()>0){c.resumeToken=Kp(s,o.resumeToken);const h=rc(s,o.expectedCount);h!==null&&(c.expectedCount=h)}else if(o.snapshotVersion.compareTo(B.min())>0){c.readTime=yr(s,o.snapshotVersion.toTimestamp());const h=rc(s,o.expectedCount);h!==null&&(c.expectedCount=h)}return c})(this.serializer,e);const n=nv(this.serializer,e);n&&(t.labels=n),this.k_(t)}Y_(e){const t={};t.database=sc(this.serializer),t.removeTarget=e,this.k_(t)}}class Wv extends Vm{constructor(e,t,n,i,s,o){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,n,i,o),this.serializer=s}get Z_(){return this.C_>0}start(){this.lastStreamToken=void 0,super.start()}U_(){this.Z_&&this.X_([])}z_(e,t){return this.connection.P_("Write",e,t)}j_(e){return U(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,U(!e.writeResults||e.writeResults.length===0,55816),this.listener.ea()}onNext(e){U(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.F_.reset();const t=tv(e.writeResults,e.commitTime),n=Te(e.commitTime);return this.listener.ta(n,t)}na(){const e={};e.database=sc(this.serializer),this.k_(e)}X_(e){const t={streamToken:this.lastStreamToken,writes:e.map((n=>Di(this.serializer,n)))};this.k_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mn="RemoteStore";class Jv{constructor(e,t,n,i,s){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Pa=[],this.Ta=new Map,this.Ia=new Set,this.da=[],this.Ea=s,this.Ea.xo((o=>{n.enqueueAndForget((async()=>{Un(this)&&(D(Mn,"Restarting streams for network reachability change."),await(async function(u){const h=F(u);h.Ia.add(4),await Qi(h),h.Aa.set("Unknown"),h.Ia.delete(4),await jo(h)})(this))}))})),this.Aa=new Xv(n,i)}}async function jo(r){if(Un(r))for(const e of r.da)await e(!0)}async function Qi(r){for(const e of r.da)await e(!1)}function qo(r,e){const t=F(r);t.Ta.has(e.targetId)||(t.Ta.set(e.targetId,e),au(t)?ou(t):Sr(t).x_()&&su(t,e))}function Er(r,e){const t=F(r),n=Sr(t);t.Ta.delete(e),n.x_()&&Dm(t,e),t.Ta.size===0&&(n.x_()?n.B_():Un(t)&&t.Aa.set("Unknown"))}function su(r,e){if(r.Ra.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(B.min())>0){const t=r.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Sr(r).H_(e)}function Dm(r,e){r.Ra.$e(e),Sr(r).Y_(e)}function ou(r){r.Ra=new GT({getRemoteKeysForTarget:e=>r.remoteSyncer.getRemoteKeysForTarget(e),Et:e=>r.Ta.get(e)||null,lt:()=>r.datastore.serializer.databaseId}),Sr(r).start(),r.Aa.aa()}function au(r){return Un(r)&&!Sr(r).M_()&&r.Ta.size>0}function Un(r){return F(r).Ia.size===0}function km(r){r.Ra=void 0}async function Yv(r){r.Aa.set("Online")}async function Zv(r){r.Ta.forEach(((e,t)=>{su(r,e)}))}async function ew(r,e){km(r),au(r)?(r.Aa.la(e),ou(r)):r.Aa.set("Unknown")}async function tw(r,e,t){if(r.Aa.set("Online"),e instanceof zp&&e.state===2&&e.cause)try{await(async function(i,s){const o=s.cause;for(const c of s.targetIds)i.Ta.has(c)&&(await i.remoteSyncer.rejectListen(c,o),i.Ta.delete(c),i.Ra.removeTarget(c))})(r,e)}catch(n){D(Mn,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await mo(r,n)}else if(e instanceof Us?r.Ra.Ye(e):e instanceof $p?r.Ra.it(e):r.Ra.et(e),!t.isEqual(B.min()))try{const n=await Tm(r.localStore);t.compareTo(n)>=0&&await(function(s,o){const c=s.Ra.Pt(o);return c.targetChanges.forEach(((u,h)=>{if(u.resumeToken.approximateByteSize()>0){const f=s.Ta.get(h);f&&s.Ta.set(h,f.withResumeToken(u.resumeToken,o))}})),c.targetMismatches.forEach(((u,h)=>{const f=s.Ta.get(u);if(!f)return;s.Ta.set(u,f.withResumeToken(pe.EMPTY_BYTE_STRING,f.snapshotVersion)),Dm(s,u);const m=new gt(f.target,u,h,f.sequenceNumber);su(s,m)})),s.remoteSyncer.applyRemoteEvent(c)})(r,t)}catch(n){D(Mn,"Failed to raise snapshot:",n),await mo(r,n)}}async function mo(r,e,t){if(!rn(e))throw e;r.Ia.add(1),await Qi(r),r.Aa.set("Offline"),t||(t=()=>Tm(r.localStore)),r.asyncQueue.enqueueRetryable((async()=>{D(Mn,"Retrying IndexedDB access"),await t(),r.Ia.delete(1),await jo(r)}))}function Nm(r,e){return e().catch((t=>mo(r,t,e)))}async function Pr(r){const e=F(r),t=en(e);let n=e.Pa.length>0?e.Pa[e.Pa.length-1].batchId:wn;for(;nw(e);)try{const i=await Bv(e.localStore,n);if(i===null){e.Pa.length===0&&t.B_();break}n=i.batchId,rw(e,i)}catch(i){await mo(e,i)}xm(e)&&Om(e)}function nw(r){return Un(r)&&r.Pa.length<10}function rw(r,e){r.Pa.push(e);const t=en(r);t.x_()&&t.Z_&&t.X_(e.mutations)}function xm(r){return Un(r)&&!en(r).M_()&&r.Pa.length>0}function Om(r){en(r).start()}async function iw(r){en(r).na()}async function sw(r){const e=en(r);for(const t of r.Pa)e.X_(t.mutations)}async function ow(r,e,t){const n=r.Pa.shift(),i=Gc.from(n,e,t);await Nm(r,(()=>r.remoteSyncer.applySuccessfulWrite(i))),await Pr(r)}async function aw(r,e){e&&en(r).Z_&&await(async function(n,i){if((function(o){return jp(o)&&o!==S.ABORTED})(i.code)){const s=n.Pa.shift();en(n).N_(),await Nm(n,(()=>n.remoteSyncer.rejectFailedWrite(s.batchId,i))),await Pr(n)}})(r,e),xm(r)&&Om(r)}async function pd(r,e){const t=F(r);t.asyncQueue.verifyOperationInProgress(),D(Mn,"RemoteStore received new credentials");const n=Un(t);t.Ia.add(3),await Qi(t),n&&t.Aa.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await jo(t)}async function dc(r,e){const t=F(r);e?(t.Ia.delete(2),await jo(t)):e||(t.Ia.add(2),await Qi(t),t.Aa.set("Unknown"))}function Sr(r){return r.Va||(r.Va=(function(t,n,i){const s=F(t);return s.ia(),new Gv(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)})(r.datastore,r.asyncQueue,{Zo:Yv.bind(null,r),e_:Zv.bind(null,r),n_:ew.bind(null,r),J_:tw.bind(null,r)}),r.da.push((async e=>{e?(r.Va.N_(),au(r)?ou(r):r.Aa.set("Unknown")):(await r.Va.stop(),km(r))}))),r.Va}function en(r){return r.ma||(r.ma=(function(t,n,i){const s=F(t);return s.ia(),new Wv(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)})(r.datastore,r.asyncQueue,{Zo:()=>Promise.resolve(),e_:iw.bind(null,r),n_:aw.bind(null,r),ea:sw.bind(null,r),ta:ow.bind(null,r)}),r.da.push((async e=>{e?(r.ma.N_(),await Pr(r)):(await r.ma.stop(),r.Pa.length>0&&(D(Mn,`Stopping write stream with ${r.Pa.length} pending writes`),r.Pa=[]))}))),r.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class md{constructor(){this.fa=new se(O.comparator)}track(e){const t=e.doc.key,n=this.fa.get(t);n?e.type!==0&&n.type===3?this.fa=this.fa.insert(t,e):e.type===3&&n.type!==1?this.fa=this.fa.insert(t,{type:n.type,doc:e.doc}):e.type===2&&n.type===2?this.fa=this.fa.insert(t,{type:2,doc:e.doc}):e.type===2&&n.type===0?this.fa=this.fa.insert(t,{type:0,doc:e.doc}):e.type===1&&n.type===0?this.fa=this.fa.remove(t):e.type===1&&n.type===2?this.fa=this.fa.insert(t,{type:1,doc:n.doc}):e.type===0&&n.type===1?this.fa=this.fa.insert(t,{type:2,doc:e.doc}):M(63341,{At:e,ga:n}):this.fa=this.fa.insert(t,e)}pa(){const e=[];return this.fa.inorderTraversal(((t,n)=>{e.push(n)})),e}}class Tr{constructor(e,t,n,i,s,o,c,u,h){this.query=e,this.docs=t,this.oldDocs=n,this.docChanges=i,this.mutatedKeys=s,this.fromCache=o,this.syncStateChanged=c,this.excludesMetadataChanges=u,this.hasCachedResults=h}static fromInitialDocuments(e,t,n,i,s){const o=[];return t.forEach((c=>{o.push({type:0,doc:c})})),new Tr(e,t,ir.emptySet(t),o,n,i,!0,!1,s)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&xo(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,n=e.docChanges;if(t.length!==n.length)return!1;for(let i=0;i<t.length;i++)if(t[i].type!==n[i].type||!t[i].doc.isEqual(n[i].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cw{constructor(){this.ya=void 0,this.wa=[]}Sa(){return this.wa.some((e=>e.ba()))}}class uw{constructor(){this.queries=gd(),this.onlineState="Unknown",this.Da=new Set}terminate(){(function(t,n){const i=F(t),s=i.queries;i.queries=gd(),s.forEach(((o,c)=>{for(const u of c.wa)u.onError(n)}))})(this,new N(S.ABORTED,"Firestore shutting down"))}}function gd(){return new bt((r=>Pp(r)),xo)}async function uu(r,e){const t=F(r);let n=3;const i=e.query;let s=t.queries.get(i);s?!s.Sa()&&e.ba()&&(n=2):(s=new cw,n=e.ba()?0:1);try{switch(n){case 0:s.ya=await t.onListen(i,!0);break;case 1:s.ya=await t.onListen(i,!1);break;case 2:await t.onFirstRemoteStoreListen(i)}}catch(o){const c=Xi(o,`Initialization of query '${Jn(e.query)}' failed`);return void e.onError(c)}t.queries.set(i,s),s.wa.push(e),e.va(t.onlineState),s.ya&&e.Ca(s.ya)&&hu(t)}async function lu(r,e){const t=F(r),n=e.query;let i=3;const s=t.queries.get(n);if(s){const o=s.wa.indexOf(e);o>=0&&(s.wa.splice(o,1),s.wa.length===0?i=e.ba()?0:1:!s.Sa()&&e.ba()&&(i=2))}switch(i){case 0:return t.queries.delete(n),t.onUnlisten(n,!0);case 1:return t.queries.delete(n),t.onUnlisten(n,!1);case 2:return t.onLastRemoteStoreUnlisten(n);default:return}}function lw(r,e){const t=F(r);let n=!1;for(const i of e){const s=i.query,o=t.queries.get(s);if(o){for(const c of o.wa)c.Ca(i)&&(n=!0);o.ya=i}}n&&hu(t)}function hw(r,e,t){const n=F(r),i=n.queries.get(e);if(i)for(const s of i.wa)s.onError(t);n.queries.delete(e)}function hu(r){r.Da.forEach((e=>{e.next()}))}var fc,_d;(_d=fc||(fc={})).Fa="default",_d.Cache="cache";class du{constructor(e,t,n){this.query=e,this.Ma=t,this.xa=!1,this.Oa=null,this.onlineState="Unknown",this.options=n||{}}Ca(e){if(!this.options.includeMetadataChanges){const n=[];for(const i of e.docChanges)i.type!==3&&n.push(i);e=new Tr(e.query,e.docs,e.oldDocs,n,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.xa?this.Na(e)&&(this.Ma.next(e),t=!0):this.Ba(e,this.onlineState)&&(this.La(e),t=!0),this.Oa=e,t}onError(e){this.Ma.error(e)}va(e){this.onlineState=e;let t=!1;return this.Oa&&!this.xa&&this.Ba(this.Oa,e)&&(this.La(this.Oa),t=!0),t}Ba(e,t){if(!e.fromCache||!this.ba())return!0;const n=t!=="Offline";return(!this.options.ka||!n)&&(!e.docs.isEmpty()||e.hasCachedResults||t==="Offline")}Na(e){if(e.docChanges.length>0)return!0;const t=this.Oa&&this.Oa.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&this.options.includeMetadataChanges===!0}La(e){e=Tr.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.xa=!0,this.Ma.next(e)}ba(){return this.options.source!==fc.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yu{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.xu(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.xu(this.observer.error,e):fe("Uncaught Error in snapshot listener:",e.toString()))}Ou(){this.muted=!0}xu(e,t){setTimeout((()=>{this.muted||e(t)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vr{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new N(S.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new he(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ww=/^__.*__$/;class Hw{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return this.fieldMask!==null?new Pt(e,this.data,this.fieldMask,t,this.fieldTransforms):new Rr(e,this.data,t,this.fieldTransforms)}}class Wm{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return new Pt(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function Hm(r){switch(r){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw M(40011,{Ec:r})}}class Tu{constructor(e,t,n,i,s,o){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=i,s===void 0&&this.Ac(),this.fieldTransforms=s||[],this.fieldMask=o||[]}get path(){return this.settings.path}get Ec(){return this.settings.Ec}Rc(e){return new Tu(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Vc(e){var t;const n=(t=this.path)===null||t===void 0?void 0:t.child(e),i=this.Rc({path:n,mc:!1});return i.fc(e),i}gc(e){var t;const n=(t=this.path)===null||t===void 0?void 0:t.child(e),i=this.Rc({path:n,mc:!1});return i.Ac(),i}yc(e){return this.Rc({path:void 0,mc:!0})}wc(e){return _o(e,this.settings.methodName,this.settings.Sc||!1,this.path,this.settings.bc)}contains(e){return this.fieldMask.find((t=>e.isPrefixOf(t)))!==void 0||this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))!==void 0}Ac(){if(this.path)for(let e=0;e<this.path.length;e++)this.fc(this.path.get(e))}fc(e){if(e.length===0)throw this.wc("Document fields must not be empty");if(Hm(this.Ec)&&Ww.test(e))throw this.wc('Document fields cannot begin and end with "__"')}}class Qw{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||Bo(e)}Dc(e,t,n,i=!1){return new Tu({Ec:e,methodName:t,bc:n,path:he.emptyPath(),mc:!1,Sc:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function Dr(r){const e=r._freezeSettings(),t=Bo(r._databaseId);return new Qw(r._databaseId,!!e.ignoreUndefinedProperties,t)}function Ko(r,e,t,n,i,s={}){const o=r.Dc(s.merge||s.mergeFields?2:0,e,t,i);Ru("Data must be an object, but it was:",o,n);const c=Qm(n,o);let u,h;if(s.merge)u=new Le(o.fieldMask),h=o.fieldTransforms;else if(s.mergeFields){const f=[];for(const m of s.mergeFields){const g=mc(e,m,t);if(!o.contains(g))throw new N(S.INVALID_ARGUMENT,`Field '${g}' is specified in your field mask but missing from your input data.`);Jm(f,g)||f.push(g)}u=new Le(f),h=o.fieldTransforms.filter((m=>u.covers(m.field)))}else u=null,h=o.fieldTransforms;return new Hw(new Ae(c),u,h)}class Go extends zo{_toFieldTransform(e){if(e.Ec!==2)throw e.Ec===1?e.wc(`${this._methodName}() can only appear at the top level of your update data`):e.wc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Go}}class vu extends zo{_toFieldTransform(e){return new Fp(e.path,new mr)}isEqual(e){return e instanceof vu}}function wu(r,e,t,n){const i=r.Dc(1,e,t);Ru("Data must be an object, but it was:",i,n);const s=[],o=Ae.empty();sn(n,((u,h)=>{const f=bu(e,u,t);h=ee(h);const m=i.gc(f);if(h instanceof Go)s.push(f);else{const g=Ji(h,m);g!=null&&(s.push(f),o.set(f,g))}}));const c=new Le(s);return new Wm(o,c,i.fieldTransforms)}function Au(r,e,t,n,i,s){const o=r.Dc(1,e,t),c=[mc(e,n,t)],u=[i];if(s.length%2!=0)throw new N(S.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let g=0;g<s.length;g+=2)c.push(mc(e,s[g])),u.push(s[g+1]);const h=[],f=Ae.empty();for(let g=c.length-1;g>=0;--g)if(!Jm(h,c[g])){const b=c[g];let C=u[g];C=ee(C);const k=o.gc(b);if(C instanceof Go)h.push(b);else{const V=Ji(C,k);V!=null&&(h.push(b),f.set(b,V))}}const m=new Le(h);return new Wm(f,m,o.fieldTransforms)}function Xw(r,e,t,n=!1){return Ji(t,r.Dc(n?4:3,e))}function Ji(r,e){if(Xm(r=ee(r)))return Ru("Unsupported field value:",e,r),Qm(r,e);if(r instanceof zo)return(function(n,i){if(!Hm(i.Ec))throw i.wc(`${n._methodName}() can only be used with update() and set()`);if(!i.path)throw i.wc(`${n._methodName}() is not currently supported inside arrays`);const s=n._toFieldTransform(i);s&&i.fieldTransforms.push(s)})(r,e),null;if(r===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),r instanceof Array){if(e.settings.mc&&e.Ec!==4)throw e.wc("Nested arrays are not supported");return(function(n,i){const s=[];let o=0;for(const c of n){let u=Ji(c,i.yc(o));u==null&&(u={nullValue:"NULL_VALUE"}),s.push(u),o++}return{arrayValue:{values:s}}})(r,e)}return(function(n,i){if((n=ee(n))===null)return{nullValue:"NULL_VALUE"};if(typeof n=="number")return LT(i.serializer,n);if(typeof n=="boolean")return{booleanValue:n};if(typeof n=="string")return{stringValue:n};if(n instanceof Date){const s=te.fromDate(n);return{timestampValue:yr(i.serializer,s)}}if(n instanceof te){const s=new te(n.seconds,1e3*Math.floor(n.nanoseconds/1e3));return{timestampValue:yr(i.serializer,s)}}if(n instanceof st)return{geoPointValue:{latitude:n.latitude,longitude:n.longitude}};if(n instanceof Be)return{bytesValue:Kp(i.serializer,n._byteString)};if(n instanceof le){const s=i.databaseId,o=n.firestore._databaseId;if(!o.isEqual(s))throw i.wc(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:Qc(n.firestore._databaseId||i.databaseId,n._key.path)}}if(n instanceof ot)return(function(o,c){return{mapValue:{fields:{[Uc]:{stringValue:Bc},[hr]:{arrayValue:{values:o.toArray().map((h=>{if(typeof h!="number")throw c.wc("VectorValues must only contain numeric values.");return $c(c.serializer,h)}))}}}}}})(n,i);throw i.wc(`Unsupported field value: ${Po(n)}`)})(r,e)}function Qm(r,e){const t={};return cp(r)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):sn(r,((n,i)=>{const s=Ji(i,e.Vc(n));s!=null&&(t[n]=s)})),{mapValue:{fields:t}}}function Xm(r){return!(typeof r!="object"||r===null||r instanceof Array||r instanceof Date||r instanceof te||r instanceof st||r instanceof Be||r instanceof le||r instanceof zo||r instanceof ot)}function Ru(r,e,t){if(!Xm(t)||!Kf(t)){const n=Po(t);throw n==="an object"?e.wc(r+" a custom object"):e.wc(r+" "+n)}}function mc(r,e,t){if((e=ee(e))instanceof Vr)return e._internalPath;if(typeof e=="string")return bu(r,e);throw _o("Field path arguments must be of type string or ",r,!1,void 0,t)}const Jw=new RegExp("[~\\*/\\[\\]]");function bu(r,e,t){if(e.search(Jw)>=0)throw _o(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,r,!1,void 0,t);try{return new Vr(...e.split("."))._internalPath}catch{throw _o(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,r,!1,void 0,t)}}function _o(r,e,t,n,i){const s=n&&!n.isEmpty(),o=i!==void 0;let c=`Function ${e}() called with invalid data`;t&&(c+=" (via `toFirestore()`)"),c+=". ";let u="";return(s||o)&&(u+=" (found",s&&(u+=` in field ${n}`),o&&(u+=` in document ${i}`),u+=")"),new N(S.INVALID_ARGUMENT,c+r+u)}function Jm(r,e){return r.some((t=>t.isEqual(e)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oR(r){r=_e(r,le);const e=_e(r.firestore,Ke);return jw(cn(e),r._key).then((t=>tg(e,r,t)))}Qt._jsonSchemaVersion="firestore/querySnapshot/1.0",Qt._jsonSchema={type:ge("string",Qt._jsonSchemaVersion),bundleSource:ge("string","QuerySnapshot"),bundleName:ge("string"),bundle:ge("string")};class kr extends eg{constructor(e){super(),this.firestore=e}convertBytes(e){return new Be(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new le(this.firestore,null,t)}}function aR(r){r=_e(r,le);const e=_e(r.firestore,Ke),t=cn(e),n=new kr(e);return Bw(t,r._key).then((i=>new It(e,n,r._key,i,new vn(i!==null&&i.hasLocalMutations,!0),r.converter)))}function cR(r){r=_e(r,an);const e=_e(r.firestore,Ke),t=cn(e),n=new kr(e);return Ym(r._query),$w(t,r._query).then((i=>new Qt(e,n,r,i)))}function uR(r){r=_e(r,an);const e=_e(r.firestore,Ke),t=cn(e),n=new kr(e);return qw(t,r._query).then((i=>new Qt(e,n,r,i)))}function lR(r,e,t){r=_e(r,le);const n=_e(r.firestore,Ke),i=Ho(r.converter,e,t);return Yi(n,[Ko(Dr(n),"setDoc",r._key,i,r.converter!==null,t).toMutation(r._key,ue.none())])}function hR(r,e,t,...n){r=_e(r,le);const i=_e(r.firestore,Ke),s=Dr(i);let o;return o=typeof(e=ee(e))=="string"||e instanceof Vr?Au(s,"updateDoc",r._key,e,t,n):wu(s,"updateDoc",r._key,e),Yi(i,[o.toMutation(r._key,ue.exists(!0))])}function dR(r){return Yi(_e(r.firestore,Ke),[new br(r._key,ue.none())])}function fR(r,e){const t=_e(r.firestore,Ke),n=Kw(r),i=Ho(r.converter,e);return Yi(t,[Ko(Dr(r.firestore),"addDoc",n._key,i,r.converter!==null,{}).toMutation(n._key,ue.exists(!1))]).then((()=>n))}function pR(r,...e){var t,n,i;r=ee(r);let s={includeMetadataChanges:!1,source:"default"},o=0;typeof e[o]!="object"||Pd(e[o])||(s=e[o++]);const c={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(Pd(e[o])){const m=e[o];e[o]=(t=m.next)===null||t===void 0?void 0:t.bind(m),e[o+1]=(n=m.error)===null||n===void 0?void 0:n.bind(m),e[o+2]=(i=m.complete)===null||i===void 0?void 0:i.bind(m)}let u,h,f;if(r instanceof le)h=_e(r.firestore,Ke),f=Ki(r._key.path),u={next:m=>{e[o]&&e[o](tg(h,r,m))},error:e[o+1],complete:e[o+2]};else{const m=_e(r,an);h=_e(m.firestore,Ke),f=m._query;const g=new kr(h);u={next:b=>{e[o]&&e[o](new Qt(h,g,m,b))},error:e[o+1],complete:e[o+2]},Ym(r._query)}return(function(g,b,C,k){const V=new yu(k),$=new du(b,V,C);return g.asyncQueue.enqueueAndForget((async()=>uu(await go(g),$))),()=>{V.Ou(),g.asyncQueue.enqueueAndForget((async()=>lu(await go(g),$)))}})(cn(h),f,c,u)}function Yi(r,e){return(function(n,i){const s=new qe;return n.asyncQueue.enqueueAndForget((async()=>Iw(await Fw(n),i,s))),s.promise})(cn(r),e)}function tg(r,e,t){const n=t.docs.get(e._key),i=new kr(r);return new It(r,i,e._key,n,new vn(t.hasPendingWrites,t.fromCache),e.converter)}class nA{constructor(e){let t;this.kind="persistent",e!=null&&e.tabManager?(e.tabManager._initialize(e),t=e.tabManager):(t=sA(),t._initialize(e)),this._onlineComponentProvider=t._onlineComponentProvider,this._offlineComponentProvider=t._offlineComponentProvider}toJSON(){return{kind:this.kind}}}function mR(r){return new nA(r)}class rA{constructor(e){this.forceOwnership=e,this.kind="persistentSingleTab"}toJSON(){return{kind:this.kind}}_initialize(e){this._onlineComponentProvider=Ni.provider,this._offlineComponentProvider={build:t=>new $m(t,e==null?void 0:e.cacheSizeBytes,this.forceOwnership)}}}class iA{constructor(){this.kind="PersistentMultipleTab"}toJSON(){return{kind:this.kind}}_initialize(e){this._onlineComponentProvider=Ni.provider,this._offlineComponentProvider={build:t=>new xw(t,e==null?void 0:e.cacheSizeBytes)}}}function sA(r){return new rA(void 0)}function gR(){return new iA}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ig="storage";function ER(r=Qd(),e){r=ee(r);const n=vo(r,ig).getImmediate({identifier:e}),i=Wg("storage");return i&&LA(n,...i),n}function LA(r,e,t,n={}){OA(r,e,t,n)}function FA(r,{instanceIdentifier:e}){const t=r.getProvider("app").getImmediate(),n=r.getProvider("auth-internal"),i=r.getProvider("app-check-internal");return new MA(t,n,i,e,Fn)}function UA(){bn(new Xt(ig,FA,"PUBLIC").setMultipleInstances(!0)),rt(Nd,xd,""),rt(Nd,xd,"esm2017")}UA();export{$A as A,JA as B,KA as C,qA as D,wr as E,My as F,Lt as G,BA as H,HA as I,_R as J,RI as K,Sf as L,QA as M,pR as N,sR as O,rR as a,ER as b,gR as c,nR as d,cR as e,uR as f,eR as g,fR as h,uy as i,Kw as j,oR as k,aR as l,dR as m,lR as n,GA as o,mR as p,iR as q,jA as r,yR as s,ZA as t,hR as u,XA as v,IR as w,WA as x,zA as y,YA as z};
