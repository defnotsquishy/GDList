 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ad="storage";function vT(n=Eo(),e){n=J(n);const r=Us(n,Ad).getImmediate({identifier:e}),s=rl("storage");return s&&BE(r,...s),r}function BE(n,e,t,r={}){FE(n,e,t,r)}function jE(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new UE(t,r,s,e,en)}function qE(){Gt(new Ct(Ad,jE,"PUBLIC").setMultipleInstances(!0)),ze(Yu,Xu,""),ze(Yu,Xu,"esm2017")}qE();export{$E as A,YE as B,gT as C,Km as D,wn as E,Bl as F,yt as G,XE as H,mT as I,cT as J,yT as K,oT as a,vT as b,iT as c,lT as d,pT as e,uT as f,rT as g,Xv as h,Dp as i,fT as j,_T as k,QE as l,nT as m,ZE as n,JE as o,GE as p,aT as q,zE as r,hT as s,tT as t,dT as u,WE as v,eT as w,KE as x,HE as y,im as z};
